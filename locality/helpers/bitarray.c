...
/* BEGIN: Cython Metadata
{
    ...
    "module_name": "locality.helpers.bitarray"
}
END: Cython Metadata */
...
#define __PYX_HAVE__locality__helpers__bitarray
#define __PYX_HAVE_API__locality__helpers__bitarray
#include <string.h>
#include <stdio.h>
#include <stdlib.h>
...
/* Module declarations from 'locality.helpers.bitarray' */
...
static void __pyx_f_8locality_7helpers_8bitarray_c_bitdot(npy_intp const , npy_intp const , double const *, npy_intp const , unsigned long const *, unsigned long *); /*proto*/
...
#define __Pyx_MODULE_NAME "locality.helpers.bitarray"
int __pyx_module_is_main_locality__helpers__bitarray = 0;

/* Implementation of 'locality.helpers.bitarray' */
...
static const char __pyx_k_locality_helpers_bitarray[] = "locality.helpers.bitarray";
static const char __pyx_k_itemsize_0_for_cython_array[] = "itemsize <= 0 for cython.array";
static const char __pyx_k_ndarray_is_not_C_contiguous[] = "ndarray is not C contiguous";
static const char __pyx_k_unable_to_allocate_array_data[] = "unable to allocate array data.";
static const char __pyx_k_home_dezmond_gdrive_Python_lsh[] = "/home/dezmond/gdrive/Python/lsh/locality/helpers/bitarray.pyx";
...
static PyObject *__pyx_n_s_locality_helpers_bitarray;
...
static PyObject *__pyx_pf_8locality_7helpers_8bitarray_bitdot(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_a, PyObject *__pyx_v_b, __Pyx_memviewslice __pyx_v_out); /* proto */
...
/* "locality/helpers/bitarray.pyx":16
...
static void __pyx_f_8locality_7helpers_8bitarray_c_bitdot(npy_intp const __pyx_v_dim, npy_intp const __pyx_v_n, double const *__pyx_v_x, npy_intp const __pyx_v_m, unsigned long const *__pyx_v_y, unsigned long *__pyx_v_out) {
  npy_intp __pyx_v_i;
  npy_intp __pyx_v_j;
  npy_intp __pyx_v_k;
  double __pyx_v_d;
  ...
  /* "locality/helpers/bitarray.pyx":21
 *     cdef npy_intp i, j, k
 *     cdef double d
 ...
 */
  ...
  /* "locality/helpers/bitarray.pyx":22
 *     cdef double d
 *     cdef npy_intp size = sizeof(long)
 *     cdef npy_intp L = <npy_intp> ceil(<double> dim / size)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "locality/helpers/bitarray.pyx":24
 *     cdef npy_intp L = <npy_intp> ceil(<double> dim / size)
 * 
 *     for i in range(n):             # <<<<<<<<<<<<<<
 *         for j in range(m):
 ...
 */
  ...
  for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
    ...
    /* "locality/helpers/bitarray.pyx":25
 * 
 *     for i in range(n):
 *         for j in range(m):             # <<<<<<<<<<<<<<
 *             d = 0
 ...
 */
    ...
    for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
      ...
      /* "locality/helpers/bitarray.pyx":26
 *     for i in range(n):
 *         for j in range(m):
 *             d = 0             # <<<<<<<<<<<<<<
 *             for k in range(dim):
 ...
 */
      ...
      /* "locality/helpers/bitarray.pyx":27
 *         for j in range(m):
 *             d = 0
 *             for k in range(dim):             # <<<<<<<<<<<<<<
 *                 if y[j * L + k // size] & (1 << (k % size)):
 ...
 */
      ...
      for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
        ...
        /* "locality/helpers/bitarray.pyx":28
 *             d = 0
 *             for k in range(dim):
 *                 if y[j * L + k // size] & (1 << (k % size)):             # <<<<<<<<<<<<<<
 *                     d += x[i * dim + k]
 ...
 */
        ...
        if (__pyx_t_7) {
          ...
          /* "locality/helpers/bitarray.pyx":29
 *             for k in range(dim):
 *                 if y[j * L + k // size] & (1 << (k % size)):
 *                     d += x[i * dim + k]             # <<<<<<<<<<<<<<
 *                 else:
 ...
 */
        ...
        /* "locality/helpers/bitarray.pyx":31
 *                     d += x[i * dim + k]
 *                 else:
 *                     d -= x[i * dim + k]             # <<<<<<<<<<<<<<
 *             if d > 0:
 ...
 */
      ...
      /* "locality/helpers/bitarray.pyx":32
 *                 else:
 *                     d -= x[i * dim + k]
 *             if d > 0:             # <<<<<<<<<<<<<<
 *                 out[i * m + j] = 1
 ...
 */
      ...
      if (__pyx_t_7) {
        ...
        /* "locality/helpers/bitarray.pyx":33
 *                     d -= x[i * dim + k]
 *             if d > 0:
 *                 out[i * m + j] = 1             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
      ...
      /* "locality/helpers/bitarray.pyx":35
 *                 out[i * m + j] = 1
 *             else:
 *                 out[i * m + j] = 0             # <<<<<<<<<<<<<<
 * 
...
/* "locality/helpers/bitarray.pyx":38
 * 
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_8locality_7helpers_8bitarray_1bitdot(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_8locality_7helpers_8bitarray_bitdot[] = "\n    Returns an array with the sign of each element of the dot product of double\n    vectors in *a* and bit vectors in *b*.\n\n    Args:\n        a (array-like): Floating point vectors\n        b (array-like): Bit vectors as integers\n        out (memoryview of array-like): if large enough, the output is packed\n        contiguously into the beginning of `out`.\n\n    Raises:\n        LinAlgError: If `a` and `b` have incompatible dimensions\n        ValueError: If `out` array has wrong dimension\n    ";
static PyMethodDef __pyx_mdef_8locality_7helpers_8bitarray_1bitdot = {"bitdot", (PyCFunction)__pyx_pw_8locality_7helpers_8bitarray_1bitdot, METH_VARARGS|METH_KEYWORDS, __pyx_doc_8locality_7helpers_8bitarray_bitdot};
static PyObject *__pyx_pw_8locality_7helpers_8bitarray_1bitdot(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("locality.helpers.bitarray.bitdot", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_8locality_7helpers_8bitarray_bitdot(__pyx_self, __pyx_v_a, __pyx_v_b, __pyx_v_out);
...
static PyObject *__pyx_pf_8locality_7helpers_8bitarray_bitdot(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_a, PyObject *__pyx_v_b, __Pyx_memviewslice __pyx_v_out) {
  npy_intp __pyx_v_n;
  npy_intp __pyx_v_m;
  ...
  /* "locality/helpers/bitarray.pyx":54
 *     """
 ...
 */
  ...
  /* "locality/helpers/bitarray.pyx":62
 ...
 */
  ...
  if (__pyx_t_5) {
    ...
    /* "locality/helpers/bitarray.pyx":63
 * 
 *     if b.shape[0] < ceil(dim / 32):
 *         raise LinAlgError('Incompatible dimensions')             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "locality/helpers/bitarray.pyx":65
 *         raise LinAlgError('Incompatible dimensions')
 * 
 *     if a.ndim == 1:             # <<<<<<<<<<<<<<
 *         n = 1
 ...
 */
  ...
  if (__pyx_t_5) {
    ...
    /* "locality/helpers/bitarray.pyx":66
 * 
 *     if a.ndim == 1:
 *         n = 1             # <<<<<<<<<<<<<<
 *         a_1d = a
 ...
 */
    ...
    /* "locality/helpers/bitarray.pyx":67
 *     if a.ndim == 1:
 *         n = 1
 *         a_1d = a             # <<<<<<<<<<<<<<
 *         aptr = &a_1d[0]
 ...
 */
    ...
    /* "locality/helpers/bitarray.pyx":68
 *         n = 1
 *         a_1d = a
 *         aptr = &a_1d[0]             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /* "locality/helpers/bitarray.pyx":70
 *         aptr = &a_1d[0]
 *     else:
 *         n = a.shape[1]             # <<<<<<<<<<<<<<
 *         a_2d = a
 ...
 */
  /*else*/ {
    ...
    /* "locality/helpers/bitarray.pyx":71
 *     else:
 *         n = a.shape[1]
 *         a_2d = a             # <<<<<<<<<<<<<<
 *         aptr = &a_2d[0, 0]
 ...
 */
    ...
    /* "locality/helpers/bitarray.pyx":72
 *         n = a.shape[1]
 *         a_2d = a
 *         aptr = &a_2d[0, 0]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "locality/helpers/bitarray.pyx":74
 *         aptr = &a_2d[0, 0]
 * 
 *     if b.ndim == 1:             # <<<<<<<<<<<<<<
 *         m = 1
 ...
 */
  ...
  if (__pyx_t_5) {
    ...
    /* "locality/helpers/bitarray.pyx":75
 * 
 *     if b.ndim == 1:
 *         m = 1             # <<<<<<<<<<<<<<
 *         b_1d = b
 ...
 */
    ...
    /* "locality/helpers/bitarray.pyx":76
 *     if b.ndim == 1:
 *         m = 1
 *         b_1d = b             # <<<<<<<<<<<<<<
 *         bptr = &b_1d[0]
 ...
 */
    ...
    /* "locality/helpers/bitarray.pyx":77
 *         m = 1
 *         b_1d = b
 *         bptr = &b_1d[0]             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /* "locality/helpers/bitarray.pyx":79
 *         bptr = &b_1d[0]
 *     else:
 *         m = b.shape[1]             # <<<<<<<<<<<<<<
 *         b_2d = b
 ...
 */
  /*else*/ {
    ...
    /* "locality/helpers/bitarray.pyx":80
 *     else:
 *         m = b.shape[1]
 *         b_2d = b             # <<<<<<<<<<<<<<
 *         bptr = &b_2d[0, 0]
 ...
 */
    ...
    /* "locality/helpers/bitarray.pyx":81
 *         m = b.shape[1]
 *         b_2d = b
 *         bptr = &b_2d[0, 0]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "locality/helpers/bitarray.pyx":83
 *         bptr = &b_2d[0, 0]
 * 
 *     if out is None:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_5) {
    ...
    /* "locality/helpers/bitarray.pyx":84
 * 
 *     if out is None:
 *         out = np.empty((n, m), dtype=np.uint)             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /* "locality/helpers/bitarray.pyx":86
 *         out = np.empty((n, m), dtype=np.uint)
 *     else:
 *         if out.shape[0] != n or out.shape[1] != m:             # <<<<<<<<<<<<<<
 ...
 */
  /*else*/ {
    ...
    if (__pyx_t_5) {
      ...
      /* "locality/helpers/bitarray.pyx":87
 *     else:
 *         if out.shape[0] != n or out.shape[1] != m:
 *             raise ValueError("Output array has wrong dimension.")             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "locality/helpers/bitarray.pyx":89
 *             raise ValueError("Output array has wrong dimension.")
 * 
 *     with nogil:             # <<<<<<<<<<<<<<
 ...
 */
  {
      ...
      /*try:*/ {
        ...
        /* "locality/helpers/bitarray.pyx":90
 * 
 *     with nogil:
 *         c_bitdot(dim, n, aptr, m, bptr, &out[0, 0])             # <<<<<<<<<<<<<<
 * 
 ...
 */
        __pyx_t_19 = 0;
        __pyx_t_20 = 0;
        __pyx_f_8locality_7helpers_8bitarray_c_bitdot(__pyx_v_dim, __pyx_v_n, __pyx_v_aptr, __pyx_v_m, __pyx_v_bptr, (&(*((unsigned long *) ( /* dim=1 */ ((char *) (((unsigned long *) ( /* dim=0 */ (__pyx_v_out.data + __pyx_t_19 * __pyx_v_out.strides[0]) )) + __pyx_t_20)) )))));
      }
 ...
 */
  ...
  /* "locality/helpers/bitarray.pyx":92
 *         c_bitdot(dim, n, aptr, m, bptr, &out[0, 0])
 * 
 *     return np.asarray(out)             # <<<<<<<<<<<<<<
 */
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "locality.helpers.bitarray.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "locality.helpers.bitarray.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "locality.helpers.bitarray.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "locality.helpers.bitarray._memoryviewslice", /*tp_name*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_locality_helpers_bitarray, __pyx_k_locality_helpers_bitarray, sizeof(__pyx_k_locality_helpers_bitarray), 0, 0, 1, 1},
 ...
 */
  ...
  __pyx_codeobj__27 = (PyObject*)__Pyx_PyCode_New(3, 0, 13, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__26, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_dezmond_gdrive_Python_lsh, __pyx_n_s_bitdot, 38, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__27)) __PYX_ERR(0, 38, __pyx_L1_error)
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main_locality__helpers__bitarray) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "locality.helpers.bitarray")) {
      if (unlikely(PyDict_SetItemString(modules, "locality.helpers.bitarray", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  if (__Pyx_ExportFunction("c_bitdot", (void (*)(void))__pyx_f_8locality_7helpers_8bitarray_c_bitdot, "void (npy_intp const , npy_intp const , double const *, npy_intp const , unsigned long const *, unsigned long *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  /*--- Type init code ---*/
  ...
  /* "locality/helpers/bitarray.pyx":6
 ...
 */
  ...
  /* "locality/helpers/bitarray.pyx":7
 * # cython: profile = False
 * from Cython.Compiler.Naming import vtabptr_prefix
 * from numpy.core.numeric import outer             # <<<<<<<<<<<<<<
 * """
 ...
 */
  ...
  /* "locality/helpers/bitarray.pyx":13
 * @author: root
 * """
 * import numpy as np             # <<<<<<<<<<<<<<
 * from numpy.linalg import LinAlgError
 ...
 */
  ...
  /* "locality/helpers/bitarray.pyx":14
 * """
 * import numpy as np
 * from numpy.linalg import LinAlgError             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_3.data = NULL;
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_8locality_7helpers_8bitarray_1bitdot, NULL, __pyx_n_s_locality_helpers_bitarray); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 38, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_bitdot, __pyx_t_2) < 0) __PYX_ERR(0, 38, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "locality/helpers/bitarray.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init locality.helpers.bitarray", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init locality.helpers.bitarray");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
