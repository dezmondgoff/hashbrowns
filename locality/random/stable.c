...
/* BEGIN: Cython Metadata
{
    ...
    "module_name": "locality.random.stable"
}
END: Cython Metadata */
...
#define __PYX_HAVE__locality__random__stable
#define __PYX_HAVE_API__locality__random__stable
#include <string.h>
#include <stdio.h>
#include <stdlib.h>
...
/* Module declarations from 'locality.random.random' */
static double (*__pyx_f_8locality_6random_6random_random)(void); /*proto*/

/* Module declarations from 'locality.random.stable' */
...
static double __pyx_f_8locality_6random_6stable_stable_non_gauss_scalar(double, double, double, double); /*proto*/
static void __pyx_f_8locality_6random_6stable_stable_non_gauss_vector(int, double, double, double, double, __Pyx_memviewslice); /*proto*/
...
#define __Pyx_MODULE_NAME "locality.random.stable"
int __pyx_module_is_main_locality__random__stable = 0;

/* Implementation of 'locality.random.stable' */
...
static const char __pyx_k_random_stable[] = "random_stable";
...
static const char __pyx_k_locality_random_stable[] = "locality.random.stable";
...
static const char __pyx_k_home_dezmond_gdrive_Python_lsh[] = "/home/dezmond/gdrive/Python/lsh/locality/random/stable.pyx";
...
static PyObject *__pyx_n_s_locality_random_stable;
...
static PyObject *__pyx_n_s_random_stable;
...
static PyObject *__pyx_pf_8locality_6random_6stable_random_stable(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_alpha, double __pyx_v_beta, double __pyx_v_c, double __pyx_v_mu, PyObject *__pyx_v_shape); /* proto */
...
static double __pyx_f_8locality_6random_6stable_stable_non_gauss_scalar(double __pyx_v_alpha, double __pyx_v_beta, double __pyx_v_c, double __pyx_v_mu) {
  double __pyx_v_u;
  double __pyx_v_xi;
  double __pyx_v_w;
  double __pyx_v_t;
 ...
 *     if alpha == 1.:
 */
  __pyx_v_u = ((__pyx_f_8locality_6random_6random_random() - 0.5) * M_PI);

  /* "locality/random/stable.pyx":15
 *     u = (random() - 0.5) * M_PI
 * 
 *     if alpha == 1.:             # <<<<<<<<<<<<<<
 *         xi = M_PI_2
 ...
 *         else:
 */
      __pyx_v_w = (-log(__pyx_f_8locality_6random_6random_random()));

      /* "locality/random/stable.pyx":19
 *         if beta != 0.:
 *             w = -log(random())
 *             out = 1/xi*(xi+beta*u)*tan(u)-beta*log(xi*w*cos(u)/(xi+beta*u))             # <<<<<<<<<<<<<<
 *         else:
 *             out = tan(u)
 */
      __pyx_v_out = ((((1.0 / __pyx_v_xi) * (__pyx_v_xi + (__pyx_v_beta * __pyx_v_u))) * tan(__pyx_v_u)) - (__pyx_v_beta * log((((__pyx_v_xi * __pyx_v_w) * cos(__pyx_v_u)) / (__pyx_v_xi + (__pyx_v_beta * __pyx_v_u))))));
 ...
 *             zeta = tan(xi * alpha)
 */
    __pyx_t_1 = ((__pyx_v_beta == 1.) != 0);
    if (__pyx_t_1) {

      /* "locality/random/stable.pyx":26
 *         w = -log(random())
 *         if beta == 1.:
 *             xi = M_PI_2             # <<<<<<<<<<<<<<
 *             zeta = tan(xi * alpha)
 ...
 *         else:
 */
      __pyx_v_zeta = tan((__pyx_v_xi * __pyx_v_alpha));

      /* "locality/random/stable.pyx":28
 *             xi = M_PI_2
 *             zeta = tan(xi * alpha)
 *             t = (1 + zeta**2)**(1 / (2 * alpha))             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
      __pyx_v_t = pow((1.0 + pow(__pyx_v_zeta, 2.0)), (1.0 / (2.0 * __pyx_v_alpha)));
 ...
 *     if c != 1.:
 */
    __pyx_v_out = ((__pyx_v_t * sin((__pyx_v_alpha * (__pyx_v_u + __pyx_v_xi)))) / pow(cos(__pyx_v_u), __pyx_v_inv_alpha));

    /* "locality/random/stable.pyx":34
 *             t = (1 + zeta**2)**(1 / (2 * alpha))
 *         out = t * sin(alpha * (u + xi)) / (cos(u)**inv_alpha)
 *         out *= (cos(u - alpha * (u + xi)) / w)**(inv_alpha - 1)             # <<<<<<<<<<<<<<
 *     if c != 1.:
 *         out *= c
 */
    __pyx_v_out = (__pyx_v_out * pow((cos((__pyx_v_u - (__pyx_v_alpha * (__pyx_v_u + __pyx_v_xi)))) / __pyx_v_w), (__pyx_v_inv_alpha - 1.0)));
  }
  __pyx_L3:;

  /* "locality/random/stable.pyx":35
 *         out = t * sin(alpha * (u + xi)) / (cos(u)**inv_alpha)
 *         out *= (cos(u - alpha * (u + xi)) / w)**(inv_alpha - 1)
 *     if c != 1.:             # <<<<<<<<<<<<<<
 *         out *= c
 ...
 */
    __pyx_v_out = (__pyx_v_out * __pyx_v_c);

    /* "locality/random/stable.pyx":37
 *     if c != 1.:
 *         out *= c
 *         if alpha == 1.:             # <<<<<<<<<<<<<<
 *             out += 2/M_PI*beta*c*log(c)
 ...
 *         out += mu
 */
      __pyx_v_out = (__pyx_v_out + ((((2.0 / M_PI) * __pyx_v_beta) * __pyx_v_c) * log(__pyx_v_c)));
 ...
 * 
 */
    __pyx_v_out = (__pyx_v_out + __pyx_v_mu);
...
static void __pyx_f_8locality_6random_6stable_stable_non_gauss_vector(int __pyx_v_n, double __pyx_v_alpha, double __pyx_v_beta, double __pyx_v_c, double __pyx_v_mu, __Pyx_memviewslice __pyx_v_out) {
  int __pyx_v_i;
  double __pyx_v_u;
  double __pyx_v_xi;
  double __pyx_v_w;
 ...
 */
        __pyx_t_4 = __pyx_v_i;
        *((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_out.data) + __pyx_t_4)) )) = (((__pyx_v_xi + (__pyx_v_beta * __pyx_v_u)) * tan(__pyx_v_u)) - (__pyx_v_beta * log((((__pyx_v_xi * __pyx_v_w) * cos(__pyx_v_u)) / (__pyx_v_xi + (__pyx_v_beta * __pyx_v_u))))));

        /* "locality/random/stable.pyx":55
 *                 w = -log(random())
 *                 out[i] = (xi+beta*u)*tan(u)-beta*log(xi*w*cos(u)/(xi+beta*u))
 *                 out[i] *= 1/xi             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
        __pyx_t_5 = __pyx_v_i;
        *((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_out.data) + __pyx_t_5)) )) *= (1.0 / __pyx_v_xi);
      }
 ...
 */
        __pyx_t_6 = __pyx_v_i;
        *((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_out.data) + __pyx_t_6)) )) = tan(((__pyx_f_8locality_6random_6random_random() - 0.5) * M_PI));
      }
    }
    __pyx_L4:;
 ...
 */
      __pyx_t_7 = __pyx_v_i;
      *((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_out.data) + __pyx_t_7)) )) = ((__pyx_v_t * sin((__pyx_v_alpha * (__pyx_v_u + __pyx_v_xi)))) / pow(cos(__pyx_v_u), __pyx_v_inv_alpha));

      /* "locality/random/stable.pyx":73
 *             w = -log(random())
 *             out[i] = t*sin(alpha*(u+xi))/(cos(u)**inv_alpha)
 *             out[i] *= (cos(u-alpha*(u+xi))/w)**(inv_alpha_minus_one)             # <<<<<<<<<<<<<<
 *     if c != 1:
 ...
 */
      __pyx_t_8 = __pyx_v_i;
      *((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_out.data) + __pyx_t_8)) )) *= pow((cos((__pyx_v_u - (__pyx_v_alpha * (__pyx_v_u + __pyx_v_xi)))) / __pyx_v_w), __pyx_v_inv_alpha_minus_one);
    }
  }
  __pyx_L3:;

  /* "locality/random/stable.pyx":74
 *             out[i] = t*sin(alpha*(u+xi))/(cos(u)**inv_alpha)
 *             out[i] *= (cos(u-alpha*(u+xi))/w)**(inv_alpha_minus_one)
 *     if c != 1:             # <<<<<<<<<<<<<<
 *         for i in range(n):
 *             out[i] *= c
 */
  __pyx_t_1 = ((__pyx_v_c != 1.0) != 0);
  if (__pyx_t_1) {

    /* "locality/random/stable.pyx":75
 *             out[i] *= (cos(u-alpha*(u+xi))/w)**(inv_alpha_minus_one)
 *     if c != 1:
 *         for i in range(n):             # <<<<<<<<<<<<<<
 *             out[i] *= c
 ...
 */
      __pyx_t_9 = __pyx_v_i;
      *((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_out.data) + __pyx_t_9)) )) *= __pyx_v_c;
    }

    /* "locality/random/stable.pyx":77
 *         for i in range(n):
 *             out[i] *= c
 *         if alpha == 1:             # <<<<<<<<<<<<<<
 *             t = 2/M_PI*beta*c*log(c)
 ...
 *                 out[i] += t
 */
      __pyx_v_t = ((((2.0 / M_PI) * __pyx_v_beta) * __pyx_v_c) * log(__pyx_v_c));

      /* "locality/random/stable.pyx":79
 *         if alpha == 1:
 *             t = 2/M_PI*beta*c*log(c)
 *             for i in range(n):             # <<<<<<<<<<<<<<
 *                 out[i] += t
 ...
 */
        ...
        *((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_out.data) + __pyx_t_10)) )) += __pyx_v_t;
      }
 ...
 */
      ...
      *((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_out.data) + __pyx_t_11)) )) += __pyx_v_mu;
    }
...
/* Python wrapper */
static PyObject *__pyx_pw_8locality_6random_6stable_1random_stable(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_8locality_6random_6stable_1random_stable = {"random_stable", (PyCFunction)__pyx_pw_8locality_6random_6stable_1random_stable, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_8locality_6random_6stable_1random_stable(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("random_stable (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_alpha,&__pyx_n_s_beta,&__pyx_n_s_c,&__pyx_n_s_mu,&__pyx_n_s_shape,0};
    PyObject* values[5] = {0,0,0,0,0};

    /* "locality/random/stable.pyx":86
 * 
 * def random_stable(double alpha, double beta=0, double c=1 , double mu=0,
 *                   shape=None):             # <<<<<<<<<<<<<<
 *     if alpha <= 0 or alpha > 2:
 ...
 */
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "random_stable") < 0)) __PYX_ERR(0, 85, __pyx_L3_error)
      }
    } else {
    ...
    __pyx_v_alpha = __pyx_PyFloat_AsDouble(values[0]); if (unlikely((__pyx_v_alpha == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 85, __pyx_L3_error)
    if (values[1]) {
      __pyx_v_beta = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_beta == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 85, __pyx_L3_error)
    } else {
      __pyx_v_beta = ((double)0.0);
    }
    if (values[2]) {
      __pyx_v_c = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_c == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 85, __pyx_L3_error)
    } else {
      __pyx_v_c = ((double)1.0);
    }
    if (values[3]) {
      __pyx_v_mu = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_mu == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 85, __pyx_L3_error)
    } else {
  ...
  __Pyx_RaiseArgtupleInvalid("random_stable", 0, 1, 5, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 85, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("locality.random.stable.random_stable", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_8locality_6random_6stable_random_stable(__pyx_self, __pyx_v_alpha, __pyx_v_beta, __pyx_v_c, __pyx_v_mu, __pyx_v_shape);
...
static PyObject *__pyx_pf_8locality_6random_6stable_random_stable(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_alpha, double __pyx_v_beta, double __pyx_v_c, double __pyx_v_mu, PyObject *__pyx_v_shape) {
 ...
 */
    __pyx_t_3 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple_, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 88, __pyx_L1_error)
 ...
 */
    __pyx_t_3 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__2, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 90, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_Raise(__pyx_t_3, 0, 0, 0);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
    __pyx_t_3 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__3, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 92, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_Raise(__pyx_t_3, 0, 0, 0);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_random); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 94, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_normal); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 94, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_4 = PyFloat_FromDouble(__pyx_v_mu); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 94, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_5 = PyFloat_FromDouble((2.0 * pow(__pyx_v_c, 2.0))); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 94, __pyx_L1_error)
    ...
    __Pyx_GOTREF(__pyx_t_5);
    if (PyDict_SetItem(__pyx_t_5, __pyx_n_s_shape, __pyx_v_shape) < 0) __PYX_ERR(0, 94, __pyx_L1_error)
    __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_6, __pyx_t_5); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 94, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
    __Pyx_XDECREF(__pyx_r);
    __pyx_t_4 = PyFloat_FromDouble(__pyx_f_8locality_6random_6stable_stable_non_gauss_scalar(__pyx_v_alpha, __pyx_v_beta, __pyx_v_c, __pyx_v_mu)); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 96, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_r = __pyx_t_4;
    __pyx_t_4 = 0;
    goto __pyx_L0;
 ...
 *     n = np.prod(shape)
 */
  __pyx_t_4 = __Pyx_PyInt_EqObjC(__pyx_v_shape, __pyx_int_1, 1, 0); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 97, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_2 = __Pyx_PyObject_IsTrue(__pyx_t_4); if (unlikely(__pyx_t_2 < 0)) __PYX_ERR(0, 97, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  if (__pyx_t_2) {

    /* "locality/random/stable.pyx":98
 *         return stable_non_gauss_scalar(alpha, beta, c, mu)
 *     elif shape == 1:
 *         return stable_non_gauss_scalar(alpha, beta, c, mu)             # <<<<<<<<<<<<<<
 *     n = np.prod(shape)
 ...
 */
    __Pyx_XDECREF(__pyx_r);
    __pyx_t_4 = PyFloat_FromDouble(__pyx_f_8locality_6random_6stable_stable_non_gauss_scalar(__pyx_v_alpha, __pyx_v_beta, __pyx_v_c, __pyx_v_mu)); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 98, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_r = __pyx_t_4;
    __pyx_t_4 = 0;
    goto __pyx_L0;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_prod); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 99, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = NULL;
  ...
  if (!__pyx_t_5) {
    __pyx_t_4 = __Pyx_PyObject_CallOneArg(__pyx_t_6, __pyx_v_shape); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 99, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
  } else {
    #if CYTHON_FAST_PYCALL
    if (PyFunction_Check(__pyx_t_6)) {
      PyObject *__pyx_temp[2] = {__pyx_t_5, __pyx_v_shape};
      __pyx_t_4 = __Pyx_PyFunction_FastCall(__pyx_t_6, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 99, __pyx_L1_error)
    ...
    if (__Pyx_PyFastCFunction_Check(__pyx_t_6)) {
      PyObject *__pyx_temp[2] = {__pyx_t_5, __pyx_v_shape};
      __pyx_t_4 = __Pyx_PyCFunction_FastCall(__pyx_t_6, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 99, __pyx_L1_error)
      __Pyx_XDECREF(__pyx_t_5); __pyx_t_5 = 0;
      __Pyx_GOTREF(__pyx_t_4);
    } else
    #endif
    {
      ...
      __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_6, __pyx_t_3, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 99, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    }
  }
  ...
  /* "locality/random/stable.pyx":100
 *         return stable_non_gauss_scalar(alpha, beta, c, mu)
 *     n = np.prod(shape)
 *     out = np.empty(n)             # <<<<<<<<<<<<<<
 *     stable_non_gauss_vector(n, alpha, beta, c, mu, out)
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_n_s_empty); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 100, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_t_6 = NULL;
  ...
  if (!__pyx_t_6) {
    __pyx_t_4 = __Pyx_PyObject_CallOneArg(__pyx_t_3, __pyx_v_n); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 100, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
  } else {
    #if CYTHON_FAST_PYCALL
    if (PyFunction_Check(__pyx_t_3)) {
      PyObject *__pyx_temp[2] = {__pyx_t_6, __pyx_v_n};
      __pyx_t_4 = __Pyx_PyFunction_FastCall(__pyx_t_3, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 100, __pyx_L1_error)
    ...
    if (__Pyx_PyFastCFunction_Check(__pyx_t_3)) {
      PyObject *__pyx_temp[2] = {__pyx_t_6, __pyx_v_n};
      __pyx_t_4 = __Pyx_PyCFunction_FastCall(__pyx_t_3, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 100, __pyx_L1_error)
      __Pyx_XDECREF(__pyx_t_6); __pyx_t_6 = 0;
      __Pyx_GOTREF(__pyx_t_4);
    } else
    #endif
    {
      ...
      __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_5, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 100, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    }
  }
  ...
  /* "locality/random/stable.pyx":101
 *     n = np.prod(shape)
 *     out = np.empty(n)
 *     stable_non_gauss_vector(n, alpha, beta, c, mu, out)             # <<<<<<<<<<<<<<
 *     return out.reshape(shape)
 */
  __pyx_t_7 = __Pyx_PyInt_As_int(__pyx_v_n); if (unlikely((__pyx_t_7 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 101, __pyx_L1_error)
  __pyx_t_8 = __Pyx_PyObject_to_MemoryviewSlice_dc_double(__pyx_v_out);
  if (unlikely(!__pyx_t_8.memview)) __PYX_ERR(0, 101, __pyx_L1_error)
  __pyx_f_8locality_6random_6stable_stable_non_gauss_vector(__pyx_t_7, __pyx_v_alpha, __pyx_v_beta, __pyx_v_c, __pyx_v_mu, __pyx_t_8);
  __PYX_XDEC_MEMVIEW(&__pyx_t_8, 1);
  __pyx_t_8.memview = NULL;
  __pyx_t_8.data = NULL;

  /* "locality/random/stable.pyx":102
 *     out = np.empty(n)
 *     stable_non_gauss_vector(n, alpha, beta, c, mu, out)
 *     return out.reshape(shape)             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_v_out, __pyx_n_s_reshape); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 102, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = NULL;
  ...
  if (!__pyx_t_5) {
    __pyx_t_4 = __Pyx_PyObject_CallOneArg(__pyx_t_3, __pyx_v_shape); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 102, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
  } else {
    #if CYTHON_FAST_PYCALL
    if (PyFunction_Check(__pyx_t_3)) {
      PyObject *__pyx_temp[2] = {__pyx_t_5, __pyx_v_shape};
      __pyx_t_4 = __Pyx_PyFunction_FastCall(__pyx_t_3, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 102, __pyx_L1_error)
      __Pyx_XDECREF(__pyx_t_5); __pyx_t_5 = 0;
      __Pyx_GOTREF(__pyx_t_4);
    } else
    #endif
    ...
    if (__Pyx_PyFastCFunction_Check(__pyx_t_3)) {
      PyObject *__pyx_temp[2] = {__pyx_t_5, __pyx_v_shape};
      __pyx_t_4 = __Pyx_PyCFunction_FastCall(__pyx_t_3, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 102, __pyx_L1_error)
      __Pyx_XDECREF(__pyx_t_5); __pyx_t_5 = 0;
      __Pyx_GOTREF(__pyx_t_4);
    } else
    #endif
    {
      ...
      __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_6, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 102, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    }
  }
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "locality.random.stable.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "locality.random.stable.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "locality.random.stable.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "locality.random.stable._memoryviewslice", /*tp_name*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_locality_random_stable, __pyx_k_locality_random_stable, sizeof(__pyx_k_locality_random_stable), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_random_stable, __pyx_k_random_stable, sizeof(__pyx_k_random_stable), 0, 0, 1, 1},
 ...
 *         raise ValueError("Skewness parameter must be on [-1,1].")
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_kp_s_Stability_parameter_must_be_on_0); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 88, __pyx_L1_error)
 ...
 *         raise ValueError("Scale parameter must be greater than zero.")
 */
  __pyx_tuple__2 = PyTuple_Pack(1, __pyx_kp_s_Skewness_parameter_must_be_on_1); if (unlikely(!__pyx_tuple__2)) __PYX_ERR(0, 90, __pyx_L1_error)
 ...
 *         return np.random.normal(mu, 2*c**2, shape=shape)
 */
  __pyx_tuple__3 = PyTuple_Pack(1, __pyx_kp_s_Scale_parameter_must_be_greater); if (unlikely(!__pyx_tuple__3)) __PYX_ERR(0, 92, __pyx_L1_error)
 ...
 *     if alpha <= 0 or alpha > 2:
 */
  __pyx_tuple__26 = PyTuple_Pack(7, __pyx_n_s_alpha, __pyx_n_s_beta, __pyx_n_s_c, __pyx_n_s_mu, __pyx_n_s_shape, __pyx_n_s_n, __pyx_n_s_out); if (unlikely(!__pyx_tuple__26)) __PYX_ERR(0, 85, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__26);
  __Pyx_GIVEREF(__pyx_tuple__26);
  __pyx_codeobj__27 = (PyObject*)__Pyx_PyCode_New(5, 0, 7, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__26, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_dezmond_gdrive_Python_lsh, __pyx_n_s_random_stable, 85, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__27)) __PYX_ERR(0, 85, __pyx_L1_error)
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main_locality__random__stable) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "locality.random.stable")) {
      if (unlikely(PyDict_SetItemString(modules, "locality.random.stable", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  if (__Pyx_ExportFunction("stable_non_gauss_scalar", (void (*)(void))__pyx_f_8locality_6random_6stable_stable_non_gauss_scalar, "double (double, double, double, double)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("stable_non_gauss_vector", (void (*)(void))__pyx_f_8locality_6random_6stable_stable_non_gauss_vector, "void (int, double, double, double, double, __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  /*--- Type init code ---*/
  ...
  __pyx_t_1 = __Pyx_ImportModule("locality.random.random"); if (!__pyx_t_1) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction(__pyx_t_1, "random", (void (**)(void))&__pyx_f_8locality_6random_6random_random, "double (void)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
 ...
 *     if alpha <= 0 or alpha > 2:
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_8locality_6random_6stable_1random_stable, NULL, __pyx_n_s_locality_random_stable); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 85, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_random_stable, __pyx_t_2) < 0) __PYX_ERR(0, 85, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "locality/random/stable.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init locality.random.stable", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init locality.random.stable");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
