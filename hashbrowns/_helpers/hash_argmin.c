...
/* BEGIN: Cython Metadata
{
    ...
    "module_name": "hashbrowns.helpers.hash_argmin"
}
END: Cython Metadata */
...
#define __PYX_HAVE__hashbrowns__helpers__hash_argmin
#define __PYX_HAVE_API__hashbrowns__helpers__hash_argmin
#include <string.h>
#include <stdio.h>
#include <stdlib.h>
...
static const char *__pyx_f[] = {
  "hashbrowns/helpers/hash_argmin.pyx",
  "__init__.pxd",
  "stringsource",
  "type.pxd",
};
...
/* Module declarations from 'hashbrowns.helpers.hash_argmin' */
...
static void __pyx_f_10hashbrowns_7helpers_11hash_argmin_c_hash_argmin(double const *, long const , long const , npy_intp const *, long const , long const , long *); /*proto*/
...
#define __Pyx_MODULE_NAME "hashbrowns.helpers.hash_argmin"
int __pyx_module_is_main_hashbrowns__helpers__hash_argmin = 0;

/* Implementation of 'hashbrowns.helpers.hash_argmin' */
...
static const char __pyx_k_hashbrowns_helpers_hash_argmin[] = "hashbrowns.helpers.hash_argmin";
static const char __pyx_k_strided_and_direct_or_indirect[] = "<strided and direct or indirect>";
static const char __pyx_k_home_dezmond_git_hashbrowns_has[] = "/home/dezmond/git/hashbrowns/hashbrowns/helpers/hash_argmin.pyx";
...
static PyObject *__pyx_n_s_hashbrowns_helpers_hash_argmin;
...
static PyObject *__pyx_pf_10hashbrowns_7helpers_11hash_argmin_hash_argmin(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_d, __Pyx_memviewslice __pyx_v_idx, long __pyx_v_size, __Pyx_memviewslice __pyx_v_out); /* proto */
...
/* "hashbrowns/helpers/hash_argmin.pyx":9
 * import numpy as np
 * 
...
static void __pyx_f_10hashbrowns_7helpers_11hash_argmin_c_hash_argmin(double const *__pyx_v_d, long const __pyx_v_n, long const __pyx_v_m, npy_intp const *__pyx_v_idx, long const __pyx_v_el, long const __pyx_v_size, long *__pyx_v_out) {
  npy_intp __pyx_v_i;
  npy_intp __pyx_v_j;
  npy_intp __pyx_v_k;
  npy_intp __pyx_v_r;
  ...
  /* "hashbrowns/helpers/hash_argmin.pyx":13
 *                         long * out) nogil:
 * 
 ...
 */
  ...
  /* "hashbrowns/helpers/hash_argmin.pyx":17
 *     cdef double best, current
 * 
 *     for i in range(n):             # <<<<<<<<<<<<<<
 *         j = 0
 ...
 */
  ...
  for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
    ...
    /* "hashbrowns/helpers/hash_argmin.pyx":18
 * 
 *     for i in range(n):
 *         j = 0             # <<<<<<<<<<<<<<
 *         while j < el:
 ...
 */
    ...
    /* "hashbrowns/helpers/hash_argmin.pyx":19
 *     for i in range(n):
 *         j = 0
 *         while j < el:             # <<<<<<<<<<<<<<
 *             best = INFINITY
 ...
 */
    while (1) {
      ...
      /* "hashbrowns/helpers/hash_argmin.pyx":20
 *         j = 0
 *         while j < el:
 *             best = INFINITY             # <<<<<<<<<<<<<<
 *             argmin = 0
 ...
 */
      ...
      /* "hashbrowns/helpers/hash_argmin.pyx":21
 *         while j < el:
 *             best = INFINITY
 *             argmin = 0             # <<<<<<<<<<<<<<
 *             for k in range(size):
 ...
 */
      ...
      /* "hashbrowns/helpers/hash_argmin.pyx":22
 *             best = INFINITY
 *             argmin = 0
 *             for k in range(size):             # <<<<<<<<<<<<<<
 *                 current = d[i * m + idx[j]]
 ...
 */
      ...
      for (__pyx_t_5 = 0; __pyx_t_5 < __pyx_t_4; __pyx_t_5+=1) {
        ...
        /* "hashbrowns/helpers/hash_argmin.pyx":23
 *             argmin = 0
 *             for k in range(size):
 *                 current = d[i * m + idx[j]]             # <<<<<<<<<<<<<<
 *                 if current < best:
 ...
 */
        ...
        /* "hashbrowns/helpers/hash_argmin.pyx":24
 *             for k in range(size):
 *                 current = d[i * m + idx[j]]
 *                 if current < best:             # <<<<<<<<<<<<<<
 *                     best = current
 ...
 */
        ...
        if (__pyx_t_3) {
          ...
          /* "hashbrowns/helpers/hash_argmin.pyx":25
 *                 current = d[i * m + idx[j]]
 *                 if current < best:
 *                     best = current             # <<<<<<<<<<<<<<
 *                     argmin = k
 ...
 */
          ...
          /* "hashbrowns/helpers/hash_argmin.pyx":26
 *                 if current < best:
 *                     best = current
 *                     argmin = k             # <<<<<<<<<<<<<<
 *                 j += 1
 ...
 */
        ...
        /* "hashbrowns/helpers/hash_argmin.pyx":27
 *                     best = current
 *                     argmin = k
 *                 j += 1             # <<<<<<<<<<<<<<
 *             out[r] = argmin
 ...
 */
      ...
      /* "hashbrowns/helpers/hash_argmin.pyx":28
 *                     argmin = k
 *                 j += 1
 *             out[r] = argmin             # <<<<<<<<<<<<<<
 *             r += 1
 ...
 */
      ...
      /* "hashbrowns/helpers/hash_argmin.pyx":29
 *                 j += 1
 *             out[r] = argmin
 *             r += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("hashbrowns.helpers.hash_argmin.c_hash_argmin", __pyx_clineno, __pyx_lineno, __pyx_filename, 0, 1);
  __pyx_L0:;
  __Pyx_TraceReturn(Py_None, 1);
}

/* "hashbrowns/helpers/hash_argmin.pyx":31
 *             r += 1
 * 
 * def hash_argmin(const double[:,::1] d, const npy_intp[::1] idx, const long size,             # <<<<<<<<<<<<<<
 *                 long[::1] out):
...
/* Python wrapper */
static PyObject *__pyx_pw_10hashbrowns_7helpers_11hash_argmin_1hash_argmin(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_10hashbrowns_7helpers_11hash_argmin_1hash_argmin = {"hash_argmin", (PyCFunction)__pyx_pw_10hashbrowns_7helpers_11hash_argmin_1hash_argmin, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_10hashbrowns_7helpers_11hash_argmin_1hash_argmin(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("hashbrowns.helpers.hash_argmin.hash_argmin", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_10hashbrowns_7helpers_11hash_argmin_hash_argmin(__pyx_self, __pyx_v_d, __pyx_v_idx, __pyx_v_size, __pyx_v_out);
...
static PyObject *__pyx_pf_10hashbrowns_7helpers_11hash_argmin_hash_argmin(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_d, __Pyx_memviewslice __pyx_v_idx, long __pyx_v_size, __Pyx_memviewslice __pyx_v_out) {
  ...
  /* "hashbrowns/helpers/hash_argmin.pyx":33
 * def hash_argmin(const double[:,::1] d, const npy_intp[::1] idx, const long size,
 *                 long[::1] out):
 *     with nogil:             # <<<<<<<<<<<<<<
 ...
 */
  {
      ...
      /*try:*/ {
        ...
        /* "hashbrowns/helpers/hash_argmin.pyx":34
 *                 long[::1] out):
 *     with nogil:
 *         c_hash_argmin(&d[0,0], d.shape[0], d.shape[1], &idx[0], idx.shape[0],             # <<<<<<<<<<<<<<
 *                       size, &out[0])
 ...
 */
        ...
        /* "hashbrowns/helpers/hash_argmin.pyx":35
 *     with nogil:
 *         c_hash_argmin(&d[0,0], d.shape[0], d.shape[1], &idx[0], idx.shape[0],
 *                       size, &out[0])             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
        __pyx_f_10hashbrowns_7helpers_11hash_argmin_c_hash_argmin((&(*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_d.data + __pyx_t_1 * __pyx_v_d.strides[0]) )) + __pyx_t_2)) )))), (__pyx_v_d.shape[0]), (__pyx_v_d.shape[1]), (&(*((npy_intp *) ( /* dim=0 */ ((char *) (((npy_intp *) __pyx_v_idx.data) + __pyx_t_3)) )))), (__pyx_v_idx.shape[0]), __pyx_v_size, (&(*((long *) ( /* dim=0 */ ((char *) (((long *) __pyx_v_out.data) + __pyx_t_4)) )))));
      }
 ...
 */
  ...
  /* "hashbrowns/helpers/hash_argmin.pyx":37
 *                       size, &out[0])
 * 
 *     return np.asarray(out)             # <<<<<<<<<<<<<<
 */
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "hashbrowns.helpers.hash_argmin.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "hashbrowns.helpers.hash_argmin.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "hashbrowns.helpers.hash_argmin.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "hashbrowns.helpers.hash_argmin._memoryviewslice", /*tp_name*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_hashbrowns_helpers_hash_argmin, __pyx_k_hashbrowns_helpers_hash_argmin, sizeof(__pyx_k_hashbrowns_helpers_hash_argmin), 0, 0, 1, 1},
 ...
 *     with nogil:
 */
  __pyx_tuple__24 = PyTuple_Pack(4, __pyx_n_s_d, __pyx_n_s_idx, __pyx_n_s_size, __pyx_n_s_out); if (unlikely(!__pyx_tuple__24)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__24);
  __Pyx_GIVEREF(__pyx_tuple__24);
  __pyx_codeobj_ = (PyObject*)__Pyx_PyCode_New(4, 0, 4, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__24, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_dezmond_git_hashbrowns_has, __pyx_n_s_hash_argmin, 31, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj_)) __PYX_ERR(0, 31, __pyx_L1_error)
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main_hashbrowns__helpers__hash_argmin) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "hashbrowns.helpers.hash_argmin")) {
      if (unlikely(PyDict_SetItemString(modules, "hashbrowns.helpers.hash_argmin", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  if (__Pyx_ExportFunction("c_hash_argmin", (void (*)(void))__pyx_f_10hashbrowns_7helpers_11hash_argmin_c_hash_argmin, "void (double const *, long const , long const , npy_intp const *, long const , long const , long *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  /*--- Type init code ---*/
  ...
  /* "hashbrowns/helpers/hash_argmin.pyx":7
 * # cython: profile = True
 * 
 * import numpy as np             # <<<<<<<<<<<<<<
 * 
 ...
 *     with nogil:
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_10hashbrowns_7helpers_11hash_argmin_1hash_argmin, NULL, __pyx_n_s_hashbrowns_helpers_hash_argmin); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_hash_argmin, __pyx_t_1) < 0) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "hashbrowns/helpers/hash_argmin.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init hashbrowns.helpers.hash_argmin", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init hashbrowns.helpers.hash_argmin");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
