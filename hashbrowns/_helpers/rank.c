...
struct __pyx_t_10hashbrowns_8_helpers_4rank_double_sorter;

/* "hashbrowns/_helpers/rank.pxd":6
...
static int __pyx_f_10hashbrowns_8_helpers_4rank_c_double_compare(const void *, const void *); /*proto*/
static void __pyx_f_10hashbrowns_8_helpers_4rank_c_double_argsort(long const , long const , double const *, npy_intp *); /*proto*/
static void __pyx_f_10hashbrowns_8_helpers_4rank_c_reorder_inplace(npy_intp *, npy_intp const , npy_intp const , npy_intp *); /*proto*/
static void __pyx_f_10hashbrowns_8_helpers_4rank_c_rank(npy_intp, npy_intp, double const *, npy_intp *, npy_intp const *, npy_intp *, npy_intp *); /*proto*/
...
static const char __pyx_k_hashbrowns__helpers_rank_pyx[] = "hashbrowns/_helpers/rank.pyx";
...
static PyObject *__pyx_kp_s_hashbrowns__helpers_rank_pyx;
...
static PyObject *__pyx_pf_10hashbrowns_8_helpers_4rank_rank(CYTHON_UNUSED PyObject *__pyx_self, long __pyx_v_q, long __pyx_v_n, __Pyx_memviewslice __pyx_v_dist, __Pyx_memviewslice __pyx_v_indices, __Pyx_memviewslice __pyx_v_indptr, PyObject *__pyx_v_sort, PyObject *__pyx_v_out); /* proto */
...
/* "hashbrowns/_helpers/rank.pyx":13
 * import numpy as np
 * 
...
static int __pyx_f_10hashbrowns_8_helpers_4rank_c_double_compare(const void *__pyx_v_a, const void *__pyx_v_b) {
  double __pyx_v_v;
  int __pyx_r;
  int __pyx_t_1;
 ...
 *     if v >= 0: return 1
 */
  __pyx_v_v = (((struct __pyx_t_10hashbrowns_8_helpers_4rank_double_sorter *)__pyx_v_a)->value - ((struct __pyx_t_10hashbrowns_8_helpers_4rank_double_sorter *)__pyx_v_b)->value);

  /* "hashbrowns/_helpers/rank.pyx":15
 * cdef int c_double_compare(const_void *a, const_void *b) nogil:
 *     cdef double v = ((<double_sorter*>a)).value-((<double_sorter*>b)).value
 *     if v < 0: return -1             # <<<<<<<<<<<<<<
 *     if v >= 0: return 1
 ...
 */
  ...
  /* "hashbrowns/_helpers/rank.pyx":16
 *     cdef double v = ((<double_sorter*>a)).value-((<double_sorter*>b)).value
 *     if v < 0: return -1
 *     if v >= 0: return 1             # <<<<<<<<<<<<<<
 * 
...
static void __pyx_f_10hashbrowns_8_helpers_4rank_c_double_argsort(long const __pyx_v_start, long const __pyx_v_end, double const *__pyx_v_a, npy_intp *__pyx_v_out) {
  npy_intp __pyx_v_i;
  npy_intp __pyx_v_j;
  npy_intp __pyx_v_n;
  struct __pyx_t_10hashbrowns_8_helpers_4rank_double_sorter *__pyx_v_order;
  npy_intp __pyx_t_1;
  npy_intp __pyx_t_2;

  /* "hashbrowns/_helpers/rank.pyx":20
 * cdef void c_double_argsort(const long start, const long end, const double * a,
 *                            npy_intp * out) nogil:
 *     cdef npy_intp i, j = start, n = end - start             # <<<<<<<<<<<<<<
 ...
 *         order[i].index = i
 */
  __pyx_v_order = ((struct __pyx_t_10hashbrowns_8_helpers_4rank_double_sorter *)malloc((__pyx_v_n * (sizeof(struct __pyx_t_10hashbrowns_8_helpers_4rank_double_sorter)))));
 ...
 */
    (__pyx_v_order[__pyx_v_i]).value = (__pyx_v_a[__pyx_v_j]);
 ...
 */
  qsort(((void *)__pyx_v_order), __pyx_v_n, (sizeof(struct __pyx_t_10hashbrowns_8_helpers_4rank_double_sorter)), __pyx_f_10hashbrowns_8_helpers_4rank_c_double_compare);
 ...
 * 
 */
    (__pyx_v_out[__pyx_v_i]) = ((npy_intp)(__pyx_v_order[__pyx_v_i]).index);
  }

  /* "hashbrowns/_helpers/rank.pyx":29
 *     for i in range(n):
 *         out[i] = <npy_intp> order[i].index
 *     free(order)             # <<<<<<<<<<<<<<
 * 
...
static void __pyx_f_10hashbrowns_8_helpers_4rank_c_reorder_inplace(npy_intp *__pyx_v_a, npy_intp const __pyx_v_start, npy_intp const __pyx_v_end, npy_intp *__pyx_v_order) {
  npy_intp __pyx_v_i;
  npy_intp __pyx_v_j;
  npy_intp __pyx_v_t;
  npy_intp __pyx_v_n;
 ...
 */
  ...
  /* "hashbrowns/_helpers/rank.pyx":36
 * 
 *     a += start
 *     n = end - start             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
    ...
    /* "hashbrowns/_helpers/rank.pyx":39
 * 
 *     for i in range(n):
 *         if order[i] >= 0:             # <<<<<<<<<<<<<<
 *             if order[i] != i:
 ...
 */
        while (1) {
          ...
          /* "hashbrowns/_helpers/rank.pyx":44
 *                 j = i
 *                 while True:
 *                     if order[j] != i:             # <<<<<<<<<<<<<<
 *                         a[j] = a[order[j]]
 ...
 */
          /*else*/ {
            ...
            /* "hashbrowns/_helpers/rank.pyx":48
 *                     else:
 *                         a[j] = t
 *                         order[j] = -1             # <<<<<<<<<<<<<<
 *                         break
...
static void __pyx_f_10hashbrowns_8_helpers_4rank_c_rank(npy_intp __pyx_v_m, npy_intp __pyx_v_n, double const *__pyx_v_a, npy_intp *__pyx_v_indices, npy_intp const *__pyx_v_indptr, npy_intp *__pyx_v_sort, npy_intp *__pyx_v_out) {
  npy_intp __pyx_v_i;
  npy_intp __pyx_v_j;
  npy_intp __pyx_v_k;
  npy_intp __pyx_v_start;
  npy_intp __pyx_v_end;
  npy_intp __pyx_t_1;
  npy_intp __pyx_t_2;
  npy_intp __pyx_t_3;
  npy_intp __pyx_t_4;
 ...
 */
  ...
  /* "hashbrowns/_helpers/rank.pyx":57
 *     cdef npy_intp i, j, k=0, start, end
 * 
 *     for i in range(n):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
    ...
    /* "hashbrowns/_helpers/rank.pyx":58
 * 
 *     for i in range(n):
 *         start, end = indptr[i], indptr[i+1]             # <<<<<<<<<<<<<<
 *         c_double_argsort(start, end, a, sort)
 ...
 */
    ...
    /* "hashbrowns/_helpers/rank.pyx":59
 *     for i in range(n):
 *         start, end = indptr[i], indptr[i+1]
 *         c_double_argsort(start, end, a, sort)             # <<<<<<<<<<<<<<
 *         c_reorder_inplace(indices, start, end, sort)
 * 
 */
    __pyx_f_10hashbrowns_8_helpers_4rank_c_double_argsort(__pyx_v_start, __pyx_v_end, __pyx_v_a, __pyx_v_sort);

    /* "hashbrowns/_helpers/rank.pyx":60
 *         start, end = indptr[i], indptr[i+1]
 *         c_double_argsort(start, end, a, sort)
 *         c_reorder_inplace(indices, start, end, sort)             # <<<<<<<<<<<<<<
 * 
 *         if end - start >= m:
 */
    __pyx_f_10hashbrowns_8_helpers_4rank_c_reorder_inplace(__pyx_v_indices, __pyx_v_start, __pyx_v_end, __pyx_v_sort);
 ...
 */
      ...
      /* "hashbrowns/_helpers/rank.pyx":68
 *             for j in range(end - start):
 *                 out[k + j] = indices[start + j]
 *             for j in range(m - end + start):             # <<<<<<<<<<<<<<
 *                 out[k + end - start + j] = -1
 ...
 * 
 */
        (__pyx_v_out[(((__pyx_v_k + __pyx_v_end) - __pyx_v_start) + __pyx_v_j)]) = -1;
      }
    }
    __pyx_L5:;
...
static PyObject *__pyx_pw_10hashbrowns_8_helpers_4rank_1rank(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_q,&__pyx_n_s_n,&__pyx_n_s_dist,&__pyx_n_s_indices,&__pyx_n_s_indptr,&__pyx_n_s_sort,&__pyx_n_s_out,0};
    PyObject* values[7] = {0,0,0,0,0,0,0};

    /* "hashbrowns/_helpers/rank.pyx":73
 * 
 * def rank(long q, long n, double[::1] dist, npy_intp[::1] indices,
 *          npy_intp [::1] indptr, sort=None, out=None):             # <<<<<<<<<<<<<<
 *     cdef npy_intp[::1] sort_1d
 ...
 */
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_n)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("rank", 0, 5, 7, 1); __PYX_ERR(0, 72, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_dist)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("rank", 0, 5, 7, 2); __PYX_ERR(0, 72, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_indices)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("rank", 0, 5, 7, 3); __PYX_ERR(0, 72, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_indptr)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("rank", 0, 5, 7, 4); __PYX_ERR(0, 72, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (kw_args > 0) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "rank") < 0)) __PYX_ERR(0, 72, __pyx_L3_error)
      }
    } else {
    ...
    __pyx_v_q = __Pyx_PyInt_As_long(values[0]); if (unlikely((__pyx_v_q == (long)-1) && PyErr_Occurred())) __PYX_ERR(0, 72, __pyx_L3_error)
    __pyx_v_n = __Pyx_PyInt_As_long(values[1]); if (unlikely((__pyx_v_n == (long)-1) && PyErr_Occurred())) __PYX_ERR(0, 72, __pyx_L3_error)
    __pyx_v_dist = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[2]); if (unlikely(!__pyx_v_dist.memview)) __PYX_ERR(0, 72, __pyx_L3_error)
    __pyx_v_indices = __Pyx_PyObject_to_MemoryviewSlice_dc_nn_npy_intp(values[3]); if (unlikely(!__pyx_v_indices.memview)) __PYX_ERR(0, 72, __pyx_L3_error)
    __pyx_v_indptr = __Pyx_PyObject_to_MemoryviewSlice_dc_nn_npy_intp(values[4]); if (unlikely(!__pyx_v_indptr.memview)) __PYX_ERR(0, 73, __pyx_L3_error)
    __pyx_v_sort = values[5];
    __pyx_v_out = values[6];
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("rank", 0, 5, 7, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 72, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("hashbrowns._helpers.rank.rank", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_10hashbrowns_8_helpers_4rank_rank(__pyx_self, __pyx_v_q, __pyx_v_n, __pyx_v_dist, __pyx_v_indices, __pyx_v_indptr, __pyx_v_sort, __pyx_v_out);
...
static PyObject *__pyx_pf_10hashbrowns_8_helpers_4rank_rank(CYTHON_UNUSED PyObject *__pyx_self, long __pyx_v_q, long __pyx_v_n, __Pyx_memviewslice __pyx_v_dist, __Pyx_memviewslice __pyx_v_indices, __Pyx_memviewslice __pyx_v_indptr, PyObject *__pyx_v_sort, PyObject *__pyx_v_out) {
  ...
  /* "hashbrowns/_helpers/rank.pyx":77
 *     cdef npy_intp[::1] out_1d
 * 
 *     if sort is None:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "hashbrowns/_helpers/rank.pyx":78
 * 
 *     if sort is None:
 *         sort = np.empty(np.max(np.diff(indptr)), dtype=np.int)             # <<<<<<<<<<<<<<
 *     if out is None:
 ...
 */
    ...
    __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_empty); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 78, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_5 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 78, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_max); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 78, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __pyx_t_7 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 78, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_7);
    __pyx_t_8 = __Pyx_PyObject_GetAttrStr(__pyx_t_7, __pyx_n_s_diff); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 78, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
    __pyx_t_7 = __pyx_memoryview_fromslice(__pyx_v_indptr, 1, (PyObject *(*)(char *)) __pyx_memview_get_nn_npy_intp, (int (*)(char *, PyObject *)) __pyx_memview_set_nn_npy_intp, 0);; if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 78, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_7);
    __pyx_t_9 = NULL;
    ...
    if (!__pyx_t_9) {
      __pyx_t_5 = __Pyx_PyObject_CallOneArg(__pyx_t_8, __pyx_t_7); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 78, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      __Pyx_GOTREF(__pyx_t_5);
    } else {
      #if CYTHON_FAST_PYCALL
      ...
      #endif
      {
        ...
        __pyx_t_7 = 0;
        __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_8, __pyx_t_10, NULL); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 78, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_5);
    ...
    if (!__pyx_t_8) {
      __pyx_t_3 = __Pyx_PyObject_CallOneArg(__pyx_t_6, __pyx_t_5); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 78, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __Pyx_GOTREF(__pyx_t_3);
    } else {
      #if CYTHON_FAST_PYCALL
      ...
      #endif
      {
        ...
        __pyx_t_5 = 0;
        __pyx_t_3 = __Pyx_PyObject_Call(__pyx_t_6, __pyx_t_10, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 78, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_3);
        __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
      }
    }
    ...
    __Pyx_GOTREF(__pyx_t_10);
    __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_10, __pyx_n_s_int); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 78, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
    if (PyDict_SetItem(__pyx_t_3, __pyx_n_s_dtype, __pyx_t_5) < 0) __PYX_ERR(0, 78, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_t_6, __pyx_t_3); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 78, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
 ...
 */
  ...
  /* "hashbrowns/_helpers/rank.pyx":79
 *     if sort is None:
 *         sort = np.empty(np.max(np.diff(indptr)), dtype=np.int)
 *     if out is None:             # <<<<<<<<<<<<<<
 *         out = np.empty(q * n, dtype=np.int)
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "hashbrowns/_helpers/rank.pyx":80
 *         sort = np.empty(np.max(np.diff(indptr)), dtype=np.int)
 *     if out is None:
 *         out = np.empty(q * n, dtype=np.int)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_empty); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 80, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __pyx_t_5 = __Pyx_PyInt_From_long((__pyx_v_q * __pyx_v_n)); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 80, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    ...
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_10 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_int); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 80, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_10);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    if (PyDict_SetItem(__pyx_t_5, __pyx_n_s_dtype, __pyx_t_10) < 0) __PYX_ERR(0, 80, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
    __pyx_t_10 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_6, __pyx_t_5); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 80, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_10);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
 ...
 */
  ...
  /* "hashbrowns/_helpers/rank.pyx":82
 *         out = np.empty(q * n, dtype=np.int)
 * 
 *     sort_1d = sort             # <<<<<<<<<<<<<<
 *     out_1d = out
 * 
 */
  __pyx_t_11 = __Pyx_PyObject_to_MemoryviewSlice_dc_nn_npy_intp(__pyx_v_sort);
  if (unlikely(!__pyx_t_11.memview)) __PYX_ERR(0, 82, __pyx_L1_error)
  __pyx_v_sort_1d = __pyx_t_11;
  __pyx_t_11.memview = NULL;
  __pyx_t_11.data = NULL;

  /* "hashbrowns/_helpers/rank.pyx":83
 * 
 *     sort_1d = sort
 *     out_1d = out             # <<<<<<<<<<<<<<
 * 
 *     with nogil:
 */
  __pyx_t_11 = __Pyx_PyObject_to_MemoryviewSlice_dc_nn_npy_intp(__pyx_v_out);
  if (unlikely(!__pyx_t_11.memview)) __PYX_ERR(0, 83, __pyx_L1_error)
  __pyx_v_out_1d = __pyx_t_11;
  __pyx_t_11.memview = NULL;
  __pyx_t_11.data = NULL;

  /* "hashbrowns/_helpers/rank.pyx":85
 *     out_1d = out
 * 
 *     with nogil:             # <<<<<<<<<<<<<<
 ...
 */
  {
      ...
      /*try:*/ {
        ...
        /* "hashbrowns/_helpers/rank.pyx":86
 * 
 *     with nogil:
 *         c_rank(q, n, &dist[0], &indices[0], &indptr[0], &sort_1d[0],             # <<<<<<<<<<<<<<
 *                &out_1d[0])
 ...
 */
        ...
        /* "hashbrowns/_helpers/rank.pyx":87
 *     with nogil:
 *         c_rank(q, n, &dist[0], &indices[0], &indptr[0], &sort_1d[0],
 *                &out_1d[0])             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
        __pyx_f_10hashbrowns_8_helpers_4rank_c_rank(__pyx_v_q, __pyx_v_n, (&(*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_dist.data) + __pyx_t_12)) )))), (&(*((npy_intp *) ( /* dim=0 */ ((char *) (((npy_intp *) __pyx_v_indices.data) + __pyx_t_13)) )))), (&(*((npy_intp *) ( /* dim=0 */ ((char *) (((npy_intp *) __pyx_v_indptr.data) + __pyx_t_14)) )))), (&(*((npy_intp *) ( /* dim=0 */ ((char *) (((npy_intp *) __pyx_v_sort_1d.data) + __pyx_t_15)) )))), (&(*((npy_intp *) ( /* dim=0 */ ((char *) (((npy_intp *) __pyx_v_out_1d.data) + __pyx_t_16)) )))));
      }
 ...
 */
  ...
  /* "hashbrowns/_helpers/rank.pyx":89
 *                &out_1d[0])
 * 
 *     return out             # <<<<<<<<<<<<<<
 */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_hashbrowns__helpers_rank_pyx, __pyx_k_hashbrowns__helpers_rank_pyx, sizeof(__pyx_k_hashbrowns__helpers_rank_pyx), 0, 0, 1, 0},
 ...
 *     cdef npy_intp[::1] sort_1d
 */
  __pyx_tuple__20 = PyTuple_Pack(9, __pyx_n_s_q, __pyx_n_s_n, __pyx_n_s_dist, __pyx_n_s_indices, __pyx_n_s_indptr, __pyx_n_s_sort, __pyx_n_s_out, __pyx_n_s_sort_1d, __pyx_n_s_out_1d); if (unlikely(!__pyx_tuple__20)) __PYX_ERR(0, 72, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__20);
  __Pyx_GIVEREF(__pyx_tuple__20);
  __pyx_codeobj__21 = (PyObject*)__Pyx_PyCode_New(7, 0, 9, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__20, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_hashbrowns__helpers_rank_pyx, __pyx_n_s_rank, 72, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__21)) __PYX_ERR(0, 72, __pyx_L1_error)
...
#endif
{
  ...
  if (__Pyx_ExportFunction("c_double_compare", (void (*)(void))__pyx_f_10hashbrowns_8_helpers_4rank_c_double_compare, "int (const void *, const void *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("c_double_argsort", (void (*)(void))__pyx_f_10hashbrowns_8_helpers_4rank_c_double_argsort, "void (long const , long const , double const *, npy_intp *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("c_reorder_inplace", (void (*)(void))__pyx_f_10hashbrowns_8_helpers_4rank_c_reorder_inplace, "void (npy_intp *, npy_intp const , npy_intp const , npy_intp *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("c_rank", (void (*)(void))__pyx_f_10hashbrowns_8_helpers_4rank_c_rank, "void (npy_intp, npy_intp, double const *, npy_intp *, npy_intp const *, npy_intp *, npy_intp *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  /*--- Type init code ---*/
  ...
  /* "hashbrowns/_helpers/rank.pyx":11
 * @author: root
 * """
 * import numpy as np             # <<<<<<<<<<<<<<
 * 
 ...
 *     cdef npy_intp[::1] sort_1d
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_10hashbrowns_8_helpers_4rank_1rank, NULL, __pyx_n_s_hashbrowns__helpers_rank); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 72, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_rank, __pyx_t_1) < 0) __PYX_ERR(0, 72, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init hashbrowns._helpers.rank", 0, __pyx_lineno, __pyx_filename);
    }
