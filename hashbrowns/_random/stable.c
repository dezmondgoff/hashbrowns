...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "language": "c",
        "name": "hashbrowns._random.stable",
        "sources": [
            "hashbrowns/_random/stable.pyx",
            "hashbrowns/_random/randomkit.c"
        ]
    },
    "module_name": "hashbrowns._random.stable"
}
END: Cython Metadata */
...
#define __PYX_HAVE__hashbrowns___random__stable
#define __PYX_HAVE_API__hashbrowns___random__stable
...
/* Module declarations from 'hashbrowns._random.stable' */
...
static void __pyx_f_10hashbrowns_7_random_6stable_c_stable_non_gauss(npy_intp, double, double, double, double, double *, rk_state *); /*proto*/
...
#define __Pyx_MODULE_NAME "hashbrowns._random.stable"
int __pyx_module_is_main_hashbrowns___random__stable = 0;

/* Implementation of 'hashbrowns._random.stable' */
...
static const char __pyx_k_hashbrowns__random_stable[] = "hashbrowns._random.stable";
static const char __pyx_k_itemsize_0_for_cython_array[] = "itemsize <= 0 for cython.array";
static const char __pyx_k_hashbrowns__random_stable_pyx[] = "hashbrowns/_random/stable.pyx";
static const char __pyx_k_unable_to_allocate_array_data[] = "unable to allocate array data.";
static const char __pyx_k_strided_and_direct_or_indirect[] = "<strided and direct or indirect>";
static const char __pyx_k_Scale_parameter_must_be_greater[] = "Scale parameter must be greater than zero.";
static const char __pyx_k_Skewness_parameter_must_be_on_1[] = "Skewness parameter must be on [-1,1].";
...
static const char __pyx_k_Stability_parameter_must_be_on_0[] = "Stability parameter must be on (0,2].";
...
static PyObject *__pyx_kp_s_Scale_parameter_must_be_greater;
static PyObject *__pyx_kp_s_Skewness_parameter_must_be_on_1;
static PyObject *__pyx_kp_s_Stability_parameter_must_be_on_0;
...
static PyObject *__pyx_n_s_hashbrowns__random_stable;
static PyObject *__pyx_kp_s_hashbrowns__random_stable_pyx;
...
static PyObject *__pyx_pf_10hashbrowns_7_random_6stable_stable(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_alpha, double __pyx_v_beta, double __pyx_v_c, double __pyx_v_mu, PyObject *__pyx_v_size, struct __pyx_obj_10hashbrowns_7_random_14randomkit_wrap_RandomStateInterface *__pyx_v_rsi); /* proto */
...
/* "hashbrowns/_random/stable.pyx":10
...
static void __pyx_f_10hashbrowns_7_random_6stable_c_stable_non_gauss(npy_intp __pyx_v_n, double __pyx_v_alpha, double __pyx_v_beta, double __pyx_v_c, double __pyx_v_mu, double *__pyx_v_out, rk_state *__pyx_v_state) {
  npy_intp __pyx_v_i;
  double __pyx_v_u;
  double __pyx_v_xi;
  double __pyx_v_inv_alpha;
  double __pyx_v_inv_alpha_minus_one;
  double __pyx_v_zeta;
  double __pyx_v_w;
  double __pyx_v_t;
  int __pyx_t_1;
  ...
  /* "hashbrowns/_random/stable.pyx":16
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "hashbrowns/_random/stable.pyx":17
 * 
 *     if alpha == 1.:
 *         if beta != 0.:             # <<<<<<<<<<<<<<
 *             for i in range(n):
 ...
 */
    __pyx_t_1 = ((__pyx_v_beta != 0.) != 0);
    if (__pyx_t_1) {

      /* "hashbrowns/_random/stable.pyx":18
 *     if alpha == 1.:
 *         if beta != 0.:
 *             for i in range(n):             # <<<<<<<<<<<<<<
 *                 u = (rk_double(state) - 0.5) * M_PI
 ...
 */
      ...
      for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
        ...
        /* "hashbrowns/_random/stable.pyx":19
 *         if beta != 0.:
 *             for i in range(n):
 *                 u = (rk_double(state) - 0.5) * M_PI             # <<<<<<<<<<<<<<
 *                 w = -log(rk_double(state))
 ...
 */
        __pyx_v_u = ((rk_double(__pyx_v_state) - 0.5) * M_PI);

        /* "hashbrowns/_random/stable.pyx":20
 *             for i in range(n):
 *                 u = (rk_double(state) - 0.5) * M_PI
 *                 w = -log(rk_double(state))             # <<<<<<<<<<<<<<
 *                 out[i] = (M_PI_2 + beta * u) * tan(u)
 ...
 */
        __pyx_v_w = (-log(rk_double(__pyx_v_state)));

        /* "hashbrowns/_random/stable.pyx":21
 *                 u = (rk_double(state) - 0.5) * M_PI
 *                 w = -log(rk_double(state))
 *                 out[i] = (M_PI_2 + beta * u) * tan(u)             # <<<<<<<<<<<<<<
 *                 out[i] -= beta * log(M_PI_2 * w * cos(u) / (M_PI_2 + beta * u))
 *                 out[i] *= M_2_PI
 */
        (__pyx_v_out[__pyx_v_i]) = ((M_PI_2 + (__pyx_v_beta * __pyx_v_u)) * tan(__pyx_v_u));

        /* "hashbrowns/_random/stable.pyx":22
 *                 w = -log(rk_double(state))
 *                 out[i] = (M_PI_2 + beta * u) * tan(u)
 *                 out[i] -= beta * log(M_PI_2 * w * cos(u) / (M_PI_2 + beta * u))             # <<<<<<<<<<<<<<
 *                 out[i] *= M_2_PI
 ...
 */
        __pyx_t_4 = __pyx_v_i;
        (__pyx_v_out[__pyx_t_4]) = ((__pyx_v_out[__pyx_t_4]) - (__pyx_v_beta * log((((M_PI_2 * __pyx_v_w) * cos(__pyx_v_u)) / (M_PI_2 + (__pyx_v_beta * __pyx_v_u))))));

        /* "hashbrowns/_random/stable.pyx":23
 *                 out[i] = (M_PI_2 + beta * u) * tan(u)
 *                 out[i] -= beta * log(M_PI_2 * w * cos(u) / (M_PI_2 + beta * u))
 *                 out[i] *= M_2_PI             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
        __pyx_t_4 = __pyx_v_i;
        (__pyx_v_out[__pyx_t_4]) = ((__pyx_v_out[__pyx_t_4]) * M_2_PI);
      }
 ...
 */
    ...
    /* "hashbrowns/_random/stable.pyx":25
 *                 out[i] *= M_2_PI
 *         else:
 *             for i in range(n):             # <<<<<<<<<<<<<<
 ...
 */
    /*else*/ {
      ...
      for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
        ...
        /* "hashbrowns/_random/stable.pyx":26
 *         else:
 *             for i in range(n):
 *                 out[i] = tan((rk_double(state) - 0.5) * M_PI)             # <<<<<<<<<<<<<<
 *     else:
 *         inv_alpha = 1 / alpha
 */
        (__pyx_v_out[__pyx_v_i]) = tan(((rk_double(__pyx_v_state) - 0.5) * M_PI));
      }
    }
    __pyx_L4:;
 ...
 */
  ...
  /* "hashbrowns/_random/stable.pyx":28
 *                 out[i] = tan((rk_double(state) - 0.5) * M_PI)
 *     else:
 *         inv_alpha = 1 / alpha             # <<<<<<<<<<<<<<
 ...
 */
  /*else*/ {
    __pyx_v_inv_alpha = (1.0 / __pyx_v_alpha);

    /* "hashbrowns/_random/stable.pyx":29
 *     else:
 *         inv_alpha = 1 / alpha
 *         inv_alpha_minus_one = inv_alpha - 1             # <<<<<<<<<<<<<<
 *         zeta = -beta * tan(M_PI_2 * alpha)
 ...
 */
    __pyx_v_inv_alpha_minus_one = (__pyx_v_inv_alpha - 1.0);

    /* "hashbrowns/_random/stable.pyx":30
 *         inv_alpha = 1 / alpha
 *         inv_alpha_minus_one = inv_alpha - 1
 *         zeta = -beta * tan(M_PI_2 * alpha)             # <<<<<<<<<<<<<<
 *         xi = inv_alpha * atan(-zeta)
 ...
 */
    __pyx_v_zeta = ((-__pyx_v_beta) * tan((M_PI_2 * __pyx_v_alpha)));

    /* "hashbrowns/_random/stable.pyx":31
 *         inv_alpha_minus_one = inv_alpha - 1
 *         zeta = -beta * tan(M_PI_2 * alpha)
 *         xi = inv_alpha * atan(-zeta)             # <<<<<<<<<<<<<<
 *         t = (1 + zeta ** 2) ** (0.5 * inv_alpha)
 *         for i in range(n):
 */
    __pyx_v_xi = (__pyx_v_inv_alpha * atan((-__pyx_v_zeta)));

    /* "hashbrowns/_random/stable.pyx":32
 *         zeta = -beta * tan(M_PI_2 * alpha)
 *         xi = inv_alpha * atan(-zeta)
 *         t = (1 + zeta ** 2) ** (0.5 * inv_alpha)             # <<<<<<<<<<<<<<
 *         for i in range(n):
 *             u = (rk_double(state) - 0.5) * M_PI
 */
    __pyx_v_t = pow((1.0 + pow(__pyx_v_zeta, 2.0)), (0.5 * __pyx_v_inv_alpha));

    /* "hashbrowns/_random/stable.pyx":33
 *         xi = inv_alpha * atan(-zeta)
 *         t = (1 + zeta ** 2) ** (0.5 * inv_alpha)
 *         for i in range(n):             # <<<<<<<<<<<<<<
 *             u = (rk_double(state) - 0.5) * M_PI
 ...
 */
    ...
    for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
      ...
      /* "hashbrowns/_random/stable.pyx":34
 *         t = (1 + zeta ** 2) ** (0.5 * inv_alpha)
 *         for i in range(n):
 *             u = (rk_double(state) - 0.5) * M_PI             # <<<<<<<<<<<<<<
 *             w = -log(rk_double(state))
 ...
 */
      ...
      /* "hashbrowns/_random/stable.pyx":35
 *         for i in range(n):
 *             u = (rk_double(state) - 0.5) * M_PI
 *             w = -log(rk_double(state))             # <<<<<<<<<<<<<<
 *             out[i] = t * sin(alpha * (u + xi))/(cos(u) ** inv_alpha)
 ...
 */
      ...
      /* "hashbrowns/_random/stable.pyx":36
 *             u = (rk_double(state) - 0.5) * M_PI
 *             w = -log(rk_double(state))
 *             out[i] = t * sin(alpha * (u + xi))/(cos(u) ** inv_alpha)             # <<<<<<<<<<<<<<
 *             out[i] *= (cos(u - alpha * (u + xi)) / w) ** (inv_alpha_minus_one)
 *     if c != 1.:
 */
      (__pyx_v_out[__pyx_v_i]) = ((__pyx_v_t * sin((__pyx_v_alpha * (__pyx_v_u + __pyx_v_xi)))) / pow(cos(__pyx_v_u), __pyx_v_inv_alpha));

      /* "hashbrowns/_random/stable.pyx":37
 *             w = -log(rk_double(state))
 *             out[i] = t * sin(alpha * (u + xi))/(cos(u) ** inv_alpha)
 *             out[i] *= (cos(u - alpha * (u + xi)) / w) ** (inv_alpha_minus_one)             # <<<<<<<<<<<<<<
 *     if c != 1.:
 ...
 */
      __pyx_t_4 = __pyx_v_i;
      (__pyx_v_out[__pyx_t_4]) = ((__pyx_v_out[__pyx_t_4]) * pow((cos((__pyx_v_u - (__pyx_v_alpha * (__pyx_v_u + __pyx_v_xi)))) / __pyx_v_w), __pyx_v_inv_alpha_minus_one));
    }
  }
  __pyx_L3:;

  /* "hashbrowns/_random/stable.pyx":38
 *             out[i] = t * sin(alpha * (u + xi))/(cos(u) ** inv_alpha)
 *             out[i] *= (cos(u - alpha * (u + xi)) / w) ** (inv_alpha_minus_one)
 *     if c != 1.:             # <<<<<<<<<<<<<<
 *         for i in range(n):
 *             out[i] *= c
 */
  __pyx_t_1 = ((__pyx_v_c != 1.) != 0);
  if (__pyx_t_1) {

    /* "hashbrowns/_random/stable.pyx":39
 *             out[i] *= (cos(u - alpha * (u + xi)) / w) ** (inv_alpha_minus_one)
 *     if c != 1.:
 *         for i in range(n):             # <<<<<<<<<<<<<<
 *             out[i] *= c
 ...
 */
    ...
    for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
      ...
      /* "hashbrowns/_random/stable.pyx":40
 *     if c != 1.:
 *         for i in range(n):
 *             out[i] *= c             # <<<<<<<<<<<<<<
 *         if alpha == 1:
 ...
 */
      __pyx_t_4 = __pyx_v_i;
      (__pyx_v_out[__pyx_t_4]) = ((__pyx_v_out[__pyx_t_4]) * __pyx_v_c);
    }

    /* "hashbrowns/_random/stable.pyx":41
 *         for i in range(n):
 *             out[i] *= c
 *         if alpha == 1:             # <<<<<<<<<<<<<<
 *             t = M_2_PI * beta * c * log(c)
 *             for i in range(n):
 */
    __pyx_t_1 = ((__pyx_v_alpha == 1.0) != 0);
    if (__pyx_t_1) {

      /* "hashbrowns/_random/stable.pyx":42
 *             out[i] *= c
 *         if alpha == 1:
 *             t = M_2_PI * beta * c * log(c)             # <<<<<<<<<<<<<<
 *             for i in range(n):
 *                 out[i] += t
 */
      __pyx_v_t = (((M_2_PI * __pyx_v_beta) * __pyx_v_c) * log(__pyx_v_c));

      /* "hashbrowns/_random/stable.pyx":43
 *         if alpha == 1:
 *             t = M_2_PI * beta * c * log(c)
 *             for i in range(n):             # <<<<<<<<<<<<<<
 *                 out[i] += t
 ...
 */
      ...
      for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
        ...
        /* "hashbrowns/_random/stable.pyx":44
 *             t = M_2_PI * beta * c * log(c)
 *             for i in range(n):
 *                 out[i] += t             # <<<<<<<<<<<<<<
 *     if mu != 0.:
 ...
 */
        __pyx_t_4 = __pyx_v_i;
        (__pyx_v_out[__pyx_t_4]) = ((__pyx_v_out[__pyx_t_4]) + __pyx_v_t);
      }
 ...
 */
  ...
  /* "hashbrowns/_random/stable.pyx":45
 *             for i in range(n):
 *                 out[i] += t
 *     if mu != 0.:             # <<<<<<<<<<<<<<
 *         for i in range(n):
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "hashbrowns/_random/stable.pyx":46
 *                 out[i] += t
 *     if mu != 0.:
 *         for i in range(n):             # <<<<<<<<<<<<<<
 *             out[i] += mu
 ...
 */
    ...
    for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
      ...
      /* "hashbrowns/_random/stable.pyx":47
 *     if mu != 0.:
 *         for i in range(n):
 *             out[i] += mu             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_4 = __pyx_v_i;
      (__pyx_v_out[__pyx_t_4]) = ((__pyx_v_out[__pyx_t_4]) + __pyx_v_mu);
    }
...
/* "hashbrowns/_random/stable.pyx":49
 *             out[i] += mu
 * 
 * def stable(double alpha, double beta=0, double c=1 , double mu=0,             # <<<<<<<<<<<<<<
...
/* Python wrapper */
static PyObject *__pyx_pw_10hashbrowns_7_random_6stable_1stable(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_10hashbrowns_7_random_6stable_stable[] = "\n    Return samples from a stable distriubtion with parameters \n    \n    Parameters\n    ----------\n    alpha : double on `(0,2]`\n        The stability parameter\n    beta : double on `[-1,1]`\n        The skewness parameter\n        The size of the intervals along the array\n    c : strictly-positive double\n        The scale parameter. Defaults to 1\n    mu : double\n        The location parameter, equal to the mean when `alpha` > 1\n        Defaults to 0.\n    size : int or tuple of ints\n        Desired size of output array\n    rsi : optional, RandomStateInterface\n        A Cython interface to a Numpy random number generator \n        Defaults: and interface to RandomState generated on import of np.random\n    \n    Returns\n    -------\n    out : ndarray\n        An array of doubles\n    \n    Raises\n    ------\n    ValueError\n        If `alpha` is not on `(0,2]`.\n    ValueError\n        If `beta` is not on `[-1,1]`.\n    ValueError\n        If `c` <= 0\n    ";
static PyMethodDef __pyx_mdef_10hashbrowns_7_random_6stable_1stable = {"stable", (PyCFunction)__pyx_pw_10hashbrowns_7_random_6stable_1stable, METH_VARARGS|METH_KEYWORDS, __pyx_doc_10hashbrowns_7_random_6stable_stable};
static PyObject *__pyx_pw_10hashbrowns_7_random_6stable_1stable(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("stable (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_alpha,&__pyx_n_s_beta,&__pyx_n_s_c,&__pyx_n_s_mu,&__pyx_n_s_size,&__pyx_n_s_rsi,0};
    PyObject* values[6] = {0,0,0,0,0,0};

    /* "hashbrowns/_random/stable.pyx":50
 * 
 * def stable(double alpha, double beta=0, double c=1 , double mu=0,
 *            object size=None, RandomStateInterface rsi=None):             # <<<<<<<<<<<<<<
 *     """
 ...
 */
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "stable") < 0)) __PYX_ERR(0, 49, __pyx_L3_error)
      }
    } else {
    ...
    if (values[1]) {
      __pyx_v_beta = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_beta == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 49, __pyx_L3_error)
    } else {
      __pyx_v_beta = ((double)0.0);
    }
    if (values[2]) {
      __pyx_v_c = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_c == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 49, __pyx_L3_error)
    } else {
      __pyx_v_c = ((double)1.0);
    }
    if (values[3]) {
      __pyx_v_mu = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_mu == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 49, __pyx_L3_error)
    } else {
  ...
  __Pyx_RaiseArgtupleInvalid("stable", 0, 1, 6, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 49, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("hashbrowns._random.stable.stable", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_rsi), __pyx_ptype_10hashbrowns_7_random_14randomkit_wrap_RandomStateInterface, 1, "rsi", 0))) __PYX_ERR(0, 50, __pyx_L1_error)
  __pyx_r = __pyx_pf_10hashbrowns_7_random_6stable_stable(__pyx_self, __pyx_v_alpha, __pyx_v_beta, __pyx_v_c, __pyx_v_mu, __pyx_v_size, __pyx_v_rsi);
...
static PyObject *__pyx_pf_10hashbrowns_7_random_6stable_stable(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_alpha, double __pyx_v_beta, double __pyx_v_c, double __pyx_v_mu, PyObject *__pyx_v_size, struct __pyx_obj_10hashbrowns_7_random_14randomkit_wrap_RandomStateInterface *__pyx_v_rsi) {
  npy_intp __pyx_v_n;
  ...
  __Pyx_RefNannySetupContext("stable", 0);
  __Pyx_INCREF((PyObject *)__pyx_v_rsi);

  /* "hashbrowns/_random/stable.pyx":91
 *     cdef rk_state * state
 * 
 *     if rsi is None:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "hashbrowns/_random/stable.pyx":92
 * 
 *     if rsi is None:
 *         rsi = randomkit._rand_interface             # <<<<<<<<<<<<<<
 *     state = rsi.state_copy
 * 
 */
    __pyx_t_3 = __Pyx_GetModuleGlobalName(__pyx_n_s_randomkit); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 92, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_rand_interface); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 92, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    if (!(likely(((__pyx_t_4) == Py_None) || likely(__Pyx_TypeTest(__pyx_t_4, __pyx_ptype_10hashbrowns_7_random_14randomkit_wrap_RandomStateInterface))))) __PYX_ERR(0, 92, __pyx_L1_error)
 ...
 */
  ...
  /* "hashbrowns/_random/stable.pyx":93
 *     if rsi is None:
 *         rsi = randomkit._rand_interface
 *     state = rsi.state_copy             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "hashbrowns/_random/stable.pyx":95
 *     state = rsi.state_copy
 * 
 *     if alpha <= 0 or alpha > 2:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __pyx_t_1 = ((__pyx_v_alpha > 2.0) != 0);
  __pyx_t_2 = __pyx_t_1;
  __pyx_L5_bool_binop_done:;
  if (__pyx_t_2) {

    /* "hashbrowns/_random/stable.pyx":96
 * 
 *     if alpha <= 0 or alpha > 2:
 *         raise ValueError("Stability parameter must be on (0,2].")             # <<<<<<<<<<<<<<
 *     if beta > 1 or beta < -1:
 ...
 */
  ...
  /* "hashbrowns/_random/stable.pyx":97
 *     if alpha <= 0 or alpha > 2:
 *         raise ValueError("Stability parameter must be on (0,2].")
 *     if beta > 1 or beta < -1:             # <<<<<<<<<<<<<<
 *         raise ValueError("Skewness parameter must be on [-1,1].")
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "hashbrowns/_random/stable.pyx":98
 *         raise ValueError("Stability parameter must be on (0,2].")
 *     if beta > 1 or beta < -1:
 *         raise ValueError("Skewness parameter must be on [-1,1].")             # <<<<<<<<<<<<<<
 *     if c <= 0:
 ...
 */
    __pyx_t_4 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__2, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 98, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_Raise(__pyx_t_4, 0, 0, 0);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
 ...
 */
  ...
  /* "hashbrowns/_random/stable.pyx":99
 *     if beta > 1 or beta < -1:
 *         raise ValueError("Skewness parameter must be on [-1,1].")
 *     if c <= 0:             # <<<<<<<<<<<<<<
 *         raise ValueError("Scale parameter must be greater than zero.")
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "hashbrowns/_random/stable.pyx":100
 *         raise ValueError("Skewness parameter must be on [-1,1].")
 *     if c <= 0:
 *         raise ValueError("Scale parameter must be greater than zero.")             # <<<<<<<<<<<<<<
 *     if alpha == 2:
 ...
 */
    __pyx_t_4 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__3, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 100, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_Raise(__pyx_t_4, 0, 0, 0);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
 ...
 */
  ...
  /* "hashbrowns/_random/stable.pyx":101
 *     if c <= 0:
 *         raise ValueError("Scale parameter must be greater than zero.")
 *     if alpha == 2:             # <<<<<<<<<<<<<<
 *         return np.random.normal(mu, c**2, size=size)
 * 
 */
  __pyx_t_2 = ((__pyx_v_alpha == 2.0) != 0);
  if (__pyx_t_2) {

    /* "hashbrowns/_random/stable.pyx":102
 *         raise ValueError("Scale parameter must be greater than zero.")
 *     if alpha == 2:
 *         return np.random.normal(mu, c**2, size=size)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_random); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 102, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_normal); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 102, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_3 = PyFloat_FromDouble(__pyx_v_mu); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 102, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_6 = PyFloat_FromDouble(pow(__pyx_v_c, 2.0)); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 102, __pyx_L1_error)
    ...
    __Pyx_GOTREF(__pyx_t_6);
    if (PyDict_SetItem(__pyx_t_6, __pyx_n_s_size, __pyx_v_size) < 0) __PYX_ERR(0, 102, __pyx_L1_error)
    __pyx_t_3 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_t_7, __pyx_t_6); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 102, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
 ...
 */
  ...
  /* "hashbrowns/_random/stable.pyx":104
 *         return np.random.normal(mu, c**2, size=size)
 * 
 *     with rsi.lock:             # <<<<<<<<<<<<<<
 *         rsi.retreive_state()
 ...
 */
  /*with:*/ {
    __pyx_t_8 = __Pyx_PyObject_LookupSpecial(__pyx_v_rsi->lock, __pyx_n_s_exit); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 104, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
    __pyx_t_6 = __Pyx_PyObject_LookupSpecial(__pyx_v_rsi->lock, __pyx_n_s_enter); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 104, __pyx_L12_error)
    __Pyx_GOTREF(__pyx_t_6);
    __pyx_t_7 = NULL;
    ...
    if (__pyx_t_7) {
      __pyx_t_3 = __Pyx_PyObject_CallOneArg(__pyx_t_6, __pyx_t_7); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 104, __pyx_L12_error)
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
    } else {
      __pyx_t_3 = __Pyx_PyObject_CallNoArg(__pyx_t_6); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 104, __pyx_L12_error)
    }
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    /*try:*/ {
      {
        ...
        /*try:*/ {
          ...
          /* "hashbrowns/_random/stable.pyx":105
 * 
 *     with rsi.lock:
 *         rsi.retreive_state()             # <<<<<<<<<<<<<<
 * 
 ...
 */
          ...
          /* "hashbrowns/_random/stable.pyx":107
 *         rsi.retreive_state()
 * 
 *         if size is None or size == 1:             # <<<<<<<<<<<<<<
 ...
 */
          ...
          __pyx_t_3 = __Pyx_PyInt_EqObjC(__pyx_v_size, __pyx_int_1, 1, 0); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 107, __pyx_L16_error)
          __Pyx_GOTREF(__pyx_t_3);
          __pyx_t_12 = __Pyx_PyObject_IsTrue(__pyx_t_3); if (unlikely(__pyx_t_12 < 0)) __PYX_ERR(0, 107, __pyx_L16_error)
          __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
          __pyx_t_2 = __pyx_t_12;
          __pyx_L23_bool_binop_done:;
          if (__pyx_t_2) {

            /* "hashbrowns/_random/stable.pyx":108
 * 
 *         if size is None or size == 1:
 *             c_stable_non_gauss(1, alpha, beta, c, mu, &scalar, state)             # <<<<<<<<<<<<<<
 *         else:
 *             n = np.prod(size)
 */
            __pyx_f_10hashbrowns_7_random_6stable_c_stable_non_gauss(1, __pyx_v_alpha, __pyx_v_beta, __pyx_v_c, __pyx_v_mu, (&__pyx_v_scalar), __pyx_v_state);
 ...
 */
          ...
          /* "hashbrowns/_random/stable.pyx":110
 *             c_stable_non_gauss(1, alpha, beta, c, mu, &scalar, state)
 *         else:
 *             n = np.prod(size)             # <<<<<<<<<<<<<<
 ...
 */
          /*else*/ {
            __pyx_t_6 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 110, __pyx_L16_error)
            __Pyx_GOTREF(__pyx_t_6);
            __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_n_s_prod); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 110, __pyx_L16_error)
            __Pyx_GOTREF(__pyx_t_7);
            __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
            __pyx_t_6 = NULL;
            ...
            if (!__pyx_t_6) {
              __pyx_t_3 = __Pyx_PyObject_CallOneArg(__pyx_t_7, __pyx_v_size); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 110, __pyx_L16_error)
              __Pyx_GOTREF(__pyx_t_3);
            } else {
              #if CYTHON_FAST_PYCALL
              if (PyFunction_Check(__pyx_t_7)) {
                PyObject *__pyx_temp[2] = {__pyx_t_6, __pyx_v_size};
                __pyx_t_3 = __Pyx_PyFunction_FastCall(__pyx_t_7, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 110, __pyx_L16_error)
              ...
              if (__Pyx_PyFastCFunction_Check(__pyx_t_7)) {
                PyObject *__pyx_temp[2] = {__pyx_t_6, __pyx_v_size};
                __pyx_t_3 = __Pyx_PyCFunction_FastCall(__pyx_t_7, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 110, __pyx_L16_error)
                __Pyx_XDECREF(__pyx_t_6); __pyx_t_6 = 0;
                __Pyx_GOTREF(__pyx_t_3);
              } else
              #endif
              {
                __pyx_t_4 = PyTuple_New(1+1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 110, __pyx_L16_error)
                __Pyx_GOTREF(__pyx_t_4);
                __Pyx_GIVEREF(__pyx_t_6); PyTuple_SET_ITEM(__pyx_t_4, 0, __pyx_t_6); __pyx_t_6 = NULL;
                __Pyx_INCREF(__pyx_v_size);
                __Pyx_GIVEREF(__pyx_v_size);
                PyTuple_SET_ITEM(__pyx_t_4, 0+1, __pyx_v_size);
                __pyx_t_3 = __Pyx_PyObject_Call(__pyx_t_7, __pyx_t_4, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 110, __pyx_L16_error)
                __Pyx_GOTREF(__pyx_t_3);
                __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
              }
            }
            __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
            __pyx_t_13 = __Pyx_PyInt_As_npy_intp(__pyx_t_3); if (unlikely((__pyx_t_13 == ((npy_intp)-1)) && PyErr_Occurred())) __PYX_ERR(0, 110, __pyx_L16_error)
            __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
            __pyx_v_n = __pyx_t_13;

            /* "hashbrowns/_random/stable.pyx":111
 *         else:
 *             n = np.prod(size)
 *             out = np.empty(n, dtype=np.double)             # <<<<<<<<<<<<<<
 *             c_stable_non_gauss(n, alpha, beta, c, mu, &out[0], state)
 * 
 */
            __pyx_t_3 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 111, __pyx_L16_error)
            __Pyx_GOTREF(__pyx_t_3);
            __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_empty); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 111, __pyx_L16_error)
            __Pyx_GOTREF(__pyx_t_7);
            __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
            __pyx_t_3 = __Pyx_PyInt_From_npy_intp(__pyx_v_n); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 111, __pyx_L16_error)
            __Pyx_GOTREF(__pyx_t_3);
            __pyx_t_4 = PyTuple_New(1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 111, __pyx_L16_error)
            __Pyx_GOTREF(__pyx_t_4);
            __Pyx_GIVEREF(__pyx_t_3);
            PyTuple_SET_ITEM(__pyx_t_4, 0, __pyx_t_3);
            __pyx_t_3 = 0;
            __pyx_t_3 = PyDict_New(); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 111, __pyx_L16_error)
            __Pyx_GOTREF(__pyx_t_3);
            __pyx_t_6 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 111, __pyx_L16_error)
            __Pyx_GOTREF(__pyx_t_6);
            __pyx_t_14 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_n_s_double); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 111, __pyx_L16_error)
            __Pyx_GOTREF(__pyx_t_14);
            __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
            if (PyDict_SetItem(__pyx_t_3, __pyx_n_s_dtype, __pyx_t_14) < 0) __PYX_ERR(0, 111, __pyx_L16_error)
            __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
            __pyx_t_14 = __Pyx_PyObject_Call(__pyx_t_7, __pyx_t_4, __pyx_t_3); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 111, __pyx_L16_error)
            __Pyx_GOTREF(__pyx_t_14);
            __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
            __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
            __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
            __pyx_t_15 = __Pyx_PyObject_to_MemoryviewSlice_dc_double(__pyx_t_14);
            if (unlikely(!__pyx_t_15.memview)) __PYX_ERR(0, 111, __pyx_L16_error)
            __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
            __pyx_v_out = __pyx_t_15;
            __pyx_t_15.memview = NULL;
            __pyx_t_15.data = NULL;

            /* "hashbrowns/_random/stable.pyx":112
 *             n = np.prod(size)
 *             out = np.empty(n, dtype=np.double)
 *             c_stable_non_gauss(n, alpha, beta, c, mu, &out[0], state)             # <<<<<<<<<<<<<<
 * 
 ...
 */
            __pyx_t_16 = 0;
            __pyx_f_10hashbrowns_7_random_6stable_c_stable_non_gauss(__pyx_v_n, __pyx_v_alpha, __pyx_v_beta, __pyx_v_c, __pyx_v_mu, (&(*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_out.data) + __pyx_t_16)) )))), __pyx_v_state);
          }
          __pyx_L22:;

          /* "hashbrowns/_random/stable.pyx":114
 *             c_stable_non_gauss(n, alpha, beta, c, mu, &out[0], state)
 * 
 *         rsi.return_state()             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        /*except:*/ {
          __Pyx_AddTraceback("hashbrowns._random.stable.stable", __pyx_clineno, __pyx_lineno, __pyx_filename);
          if (__Pyx_GetException(&__pyx_t_14, &__pyx_t_3, &__pyx_t_4) < 0) __PYX_ERR(0, 104, __pyx_L18_except_error)
          __Pyx_GOTREF(__pyx_t_14);
          __Pyx_GOTREF(__pyx_t_3);
          __Pyx_GOTREF(__pyx_t_4);
          __pyx_t_7 = PyTuple_Pack(3, __pyx_t_14, __pyx_t_3, __pyx_t_4); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 104, __pyx_L18_except_error)
          __Pyx_GOTREF(__pyx_t_7);
          __pyx_t_17 = __Pyx_PyObject_Call(__pyx_t_8, __pyx_t_7, NULL);
          __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
          __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
          if (unlikely(!__pyx_t_17)) __PYX_ERR(0, 104, __pyx_L18_except_error)
          __Pyx_GOTREF(__pyx_t_17);
          __pyx_t_2 = __Pyx_PyObject_IsTrue(__pyx_t_17);
          __Pyx_DECREF(__pyx_t_17); __pyx_t_17 = 0;
          if (__pyx_t_2 < 0) __PYX_ERR(0, 104, __pyx_L18_except_error)
          __pyx_t_12 = ((!(__pyx_t_2 != 0)) != 0);
          if (__pyx_t_12) {
            __Pyx_GIVEREF(__pyx_t_14);
            __Pyx_GIVEREF(__pyx_t_3);
            __Pyx_XGIVEREF(__pyx_t_4);
            __Pyx_ErrRestoreWithState(__pyx_t_14, __pyx_t_3, __pyx_t_4);
            __pyx_t_14 = 0; __pyx_t_3 = 0; __pyx_t_4 = 0; 
            __PYX_ERR(0, 104, __pyx_L18_except_error)
          }
          __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
          __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
          __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  ...
  /* "hashbrowns/_random/stable.pyx":116
 *         rsi.return_state()
 * 
 *     if size is None or size == 1:             # <<<<<<<<<<<<<<
 *         return scalar
 ...
 */
  ...
  __pyx_t_4 = __Pyx_PyInt_EqObjC(__pyx_v_size, __pyx_int_1, 1, 0); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 116, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  ...
  if (__pyx_t_12) {
    ...
    /* "hashbrowns/_random/stable.pyx":117
 * 
 *     if size is None or size == 1:
 *         return scalar             # <<<<<<<<<<<<<<
 *     return np.asarray(out).reshape(size)
 */
    __Pyx_XDECREF(__pyx_r);
    __pyx_t_4 = PyFloat_FromDouble(__pyx_v_scalar); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 117, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_r = __pyx_t_4;
    __pyx_t_4 = 0;
    goto __pyx_L0;
 ...
 */
  ...
  /* "hashbrowns/_random/stable.pyx":118
 *     if size is None or size == 1:
 *         return scalar
 *     return np.asarray(out).reshape(size)             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_14 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 118, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_14);
  __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_14, __pyx_n_s_asarray); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 118, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
  if (unlikely(!__pyx_v_out.memview)) { __Pyx_RaiseUnboundLocalError("out"); __PYX_ERR(0, 118, __pyx_L1_error) }
  __pyx_t_14 = __pyx_memoryview_fromslice(__pyx_v_out, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 118, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_14);
  __pyx_t_6 = NULL;
  if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_7))) {
    __pyx_t_6 = PyMethod_GET_SELF(__pyx_t_7);
  ...
  if (!__pyx_t_6) {
    __pyx_t_3 = __Pyx_PyObject_CallOneArg(__pyx_t_7, __pyx_t_14); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 118, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
    __Pyx_GOTREF(__pyx_t_3);
  } else {
    #if CYTHON_FAST_PYCALL
    if (PyFunction_Check(__pyx_t_7)) {
      ...
      __pyx_t_3 = __Pyx_PyFunction_FastCall(__pyx_t_7, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 118, __pyx_L1_error)
      __Pyx_XDECREF(__pyx_t_6); __pyx_t_6 = 0;
      __Pyx_GOTREF(__pyx_t_3);
      __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
    } else
    ...
    if (__Pyx_PyFastCFunction_Check(__pyx_t_7)) {
      PyObject *__pyx_temp[2] = {__pyx_t_6, __pyx_t_14};
      __pyx_t_3 = __Pyx_PyCFunction_FastCall(__pyx_t_7, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 118, __pyx_L1_error)
      __Pyx_XDECREF(__pyx_t_6); __pyx_t_6 = 0;
      __Pyx_GOTREF(__pyx_t_3);
      __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
    } else
    #endif
    {
      __pyx_t_18 = PyTuple_New(1+1); if (unlikely(!__pyx_t_18)) __PYX_ERR(0, 118, __pyx_L1_error)
      ...
      __pyx_t_14 = 0;
      __pyx_t_3 = __Pyx_PyObject_Call(__pyx_t_7, __pyx_t_18, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 118, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
      __Pyx_DECREF(__pyx_t_18); __pyx_t_18 = 0;
    }
  }
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_reshape); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 118, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = NULL;
  ...
  if (!__pyx_t_3) {
    __pyx_t_4 = __Pyx_PyObject_CallOneArg(__pyx_t_7, __pyx_v_size); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 118, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
  } else {
    #if CYTHON_FAST_PYCALL
    if (PyFunction_Check(__pyx_t_7)) {
    ...
    #endif
    {
      ...
      __Pyx_INCREF(__pyx_v_size);
      __Pyx_GIVEREF(__pyx_v_size);
      PyTuple_SET_ITEM(__pyx_t_18, 0+1, __pyx_v_size);
      __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_7, __pyx_t_18, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 118, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_18); __pyx_t_18 = 0;
    }
  }
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "hashbrowns._random.stable.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "hashbrowns._random.stable.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "hashbrowns._random.stable.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "hashbrowns._random.stable._memoryviewslice", /*tp_name*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_Scale_parameter_must_be_greater, __pyx_k_Scale_parameter_must_be_greater, sizeof(__pyx_k_Scale_parameter_must_be_greater), 0, 0, 1, 0},
  {&__pyx_kp_s_Skewness_parameter_must_be_on_1, __pyx_k_Skewness_parameter_must_be_on_1, sizeof(__pyx_k_Skewness_parameter_must_be_on_1), 0, 0, 1, 0},
  {&__pyx_kp_s_Stability_parameter_must_be_on_0, __pyx_k_Stability_parameter_must_be_on_0, sizeof(__pyx_k_Stability_parameter_must_be_on_0), 0, 0, 1, 0},
  ...
  {&__pyx_n_s_hashbrowns__random_stable, __pyx_k_hashbrowns__random_stable, sizeof(__pyx_k_hashbrowns__random_stable), 0, 0, 1, 1},
  {&__pyx_kp_s_hashbrowns__random_stable_pyx, __pyx_k_hashbrowns__random_stable_pyx, sizeof(__pyx_k_hashbrowns__random_stable_pyx), 0, 0, 1, 0},
 ...
 *         raise ValueError("Skewness parameter must be on [-1,1].")
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_kp_s_Stability_parameter_must_be_on_0); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 96, __pyx_L1_error)
 ...
 *         raise ValueError("Scale parameter must be greater than zero.")
 */
  __pyx_tuple__2 = PyTuple_Pack(1, __pyx_kp_s_Skewness_parameter_must_be_on_1); if (unlikely(!__pyx_tuple__2)) __PYX_ERR(0, 98, __pyx_L1_error)
 ...
 *         return np.random.normal(mu, c**2, size=size)
 */
  __pyx_tuple__3 = PyTuple_Pack(1, __pyx_kp_s_Scale_parameter_must_be_greater); if (unlikely(!__pyx_tuple__3)) __PYX_ERR(0, 100, __pyx_L1_error)
 ...
 * 
 */
  __pyx_tuple__4 = PyTuple_Pack(3, Py_None, Py_None, Py_None); if (unlikely(!__pyx_tuple__4)) __PYX_ERR(0, 104, __pyx_L1_error)
 ...
 *     """
 */
  __pyx_tuple__24 = PyTuple_Pack(10, __pyx_n_s_alpha, __pyx_n_s_beta, __pyx_n_s_c, __pyx_n_s_mu, __pyx_n_s_size, __pyx_n_s_rsi, __pyx_n_s_n, __pyx_n_s_scalar, __pyx_n_s_out, __pyx_n_s_state); if (unlikely(!__pyx_tuple__24)) __PYX_ERR(0, 49, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__24);
  __Pyx_GIVEREF(__pyx_tuple__24);
  __pyx_codeobj__25 = (PyObject*)__Pyx_PyCode_New(6, 0, 10, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__24, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_hashbrowns__random_stable_pyx, __pyx_n_s_stable, 49, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__25)) __PYX_ERR(0, 49, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initstable(void); /*proto*/
PyMODINIT_FUNC initstable(void)
#else
PyMODINIT_FUNC PyInit_stable(void); /*proto*/
PyMODINIT_FUNC PyInit_stable(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_stable(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("stable", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_hashbrowns___random__stable) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "hashbrowns._random.stable")) {
      if (unlikely(PyDict_SetItemString(modules, "hashbrowns._random.stable", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  if (__Pyx_ExportFunction("c_stable_non_gauss", (void (*)(void))__pyx_f_10hashbrowns_7_random_6stable_c_stable_non_gauss, "void (npy_intp, double, double, double, double, double *, rk_state *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  /*--- Type init code ---*/
  ...
  /* "hashbrowns/_random/stable.pyx":7
 ...
 */
  ...
  /* "hashbrowns/_random/stable.pyx":8
 * 
 * import numpy as np
 * import randomkit_wrap as randomkit             # <<<<<<<<<<<<<<
 * 
 * cdef void c_stable_non_gauss(npy_intp n, double alpha, double beta, double c,
 */
  __pyx_t_1 = __Pyx_Import(__pyx_n_s_randomkit_wrap, 0, -1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_randomkit, __pyx_t_1) < 0) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *     """
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_10hashbrowns_7_random_6stable_1stable, NULL, __pyx_n_s_hashbrowns__random_stable); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 49, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_stable, __pyx_t_1) < 0) __PYX_ERR(0, 49, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "hashbrowns/_random/stable.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init hashbrowns._random.stable", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init hashbrowns._random.stable");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
